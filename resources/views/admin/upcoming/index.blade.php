            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 py-5">
                    ...
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">Upcoming Management</span>
                    </h3>
                    ...
                    <table class="table table-bordered mt-10 w-100 text-center" id="datatables">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="" style="">{{ $item->tanggal }}</td>
                                <td class="text-truncate" style="max-width: 150px;">{!! $item->deskripsi !!}</td>
                                {{-- <td>{{ $item->created_at }}</td> --}}
                                <td>{{ $item->updated_at }}</td>
                                <td>
                                    <a href="{{ route('upcoming.edit',$item->id) }}"
                                        class="btn btn-link btn-info btn-just-icon">
                                        <i class="fa fa-pencil-alt"></i>
                                    </a>
                                    <a href="#" data-href="{{ route('upcoming.delete',$item->id) }}"
                                        class="btn btn-link btn-danger btn-just-icon" id="deleteModal">
