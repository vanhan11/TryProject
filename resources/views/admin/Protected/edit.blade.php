            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header card-header-rose card-header-text">
                        <div class="card-text">
                            <h4 class="card-title">Edit Protected Content</h4>
                        </div>
                    </div>
                    <form method="post" action="{{ route('protected.update',$data->id) }}" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        <div class="card-body ">
                            <br>
                            <br>
                        ...
                        <div class="card-footer">
                            <a href="{{ route('protected.index') }}" class="btn btn-fill btn-warning"> Back </a>
