                ...
                <form action="{{ route('register.post') }}" method="POST">
                    ...
                    <div class="card2 card border-0 px-4 pt-5 mt-2">
                        ...
                        <div class="row px-3 mb-4">
                            ...
                            <input class=" form-control @error('name') is-invalid @enderror" type="text" name="name" placeholder="Enter Firstname" value="{{ old('name') }}"> 
                            @error('name') 
                        ...
                        <div class="row mb-4 px-3"> 
                            <small class="font-weight-bold">
                                Already have an account? <a class="text-danger" href="{{ route('login.index') }}">Login</a>
                            </small>
                         </div> 
                    </div>
                </form>
