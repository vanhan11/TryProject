        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card ">
                    ...
                    <form method="post" action="{{ route('blog.update',$data->id) }}" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        <div class="card-body ">
                            <br>
                            <br>
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" value="" name="upload" id="customFile" />
                        ...
                        <div class="card-footer">
                            <a href="{{ route('blog.index') }}" class="btn btn-fill btn-warning"> Back </a>
