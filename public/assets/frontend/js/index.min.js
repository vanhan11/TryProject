...
function() {
    ...
    function h() {
        ...
        var e = document.body,
            ...
            f = e.scrollHeight;
        o = document.compatMode.indexOf("CSS") >= 0 ? i : e, u = e, c(), s = !0;
        if (top != self) r = !0;
        else if (f > a && (e.offsetHeight <= a || i.offsetHeight <= a)) {
            var l = !1,
                h = function() {
                    !l && i.scrollHeight != document.height && (l = !0, setTimeout(function() {
        ...
        }!t.fixedBackground && !n && (e.style.backgroundAttachment = "scroll", i.style.backgroundAttachment = "scroll")
    }
            ...
            f = function(s) {
                ...
                for (var c = 0; c < p.length; c++) {
                    ...
                    var y = h.x * g - h.lastX >> 0,
                        b = h.y * g - h.lastY >> 0;
                    u += y, l += b, h.lastX += y, h.lastY += b, m && (p.splice(c, 1), c--)
                }
                a ? window.scrollBy(u, l) : (u && (e.scrollLeft += u), l && (e.scrollTop += l)), !n && !r && (p = []), p.length ? M(f, e, i / t.frameRate + 1) : d = !1
            };
        M(f, e, 0), d = !0
    }
    ...
    function g(e) {
        ...
        var n = e.target,
            r = x(n);
        if (!r || e.defaultPrevented || C(u, "embed") || C(n, "embed") && /\.pdf/i.test(n.src)) return !0;
        var i = e.wheelDeltaX || 0,
            o = e.wheelDeltaY || 0;
        !i && !o && (o = e.wheelDelta || 0);
        if (!t.touchpadSupport && A(o)) return !0;
        Math.abs(i) > 1.2 && (i *= t.stepSize / 120), Math.abs(o) > 1.2 && (o *= t.stepSize / 120), m(r, -i, -o), e.preventDefault()
    }

    function y(e) {
        var n = e.target,
            r = e.ctrlKey || e.altKey || e.metaKey || e.shiftKey && e.keyCode !== l.spacebar;
        if (/input|textarea|select|embed/i.test(n.nodeName) || n.isContentEditable || e.defaultPrevented || r) return !0;
    ...
    function _(e) {
        var n, r, i;
        return e *= t.pulseScale, e < 1 ? n = e - (1 - Math.exp(-e)) : (r = Math.exp(-1), e -= 1, i = 1 - Math.exp(-e), n = r + i * (1 - r)), n * t.pulseNormalize
    }

    function D(e) {
        return e >= 1 ? 1 : e <= 0 ? 0 : (t.pulseNormalize == 1 && (t.pulseNormalize /= _(1)), _(e))
    }
    var e = {
            frameRate: 150,
            animationTime: 400,
    ...
    var E = function() {
        ...
        H = null;
    "onwheel" in document.createElement("div") ? H = "wheel" : "onmousewheel" in document.createElement("div") && (H = "mousewheel"), H && P && (T(H, g), T("mousedown", b), T("load", h))
}(), define("smoothscroll", function() {}), ! function(e, t, n, r) {
        function i(t, n) {
            this.settings = null, this.options = e.extend({}, i.Defaults, n), this.$element = e(t), this.drag = e.extend({}, h), this.state = e.extend({}, p), this.e = e.extend({}, d), this._plugins = {}, this._supress = {}, this._current = null, this._speed = null, this._coordinates = [], this._breakpoint = null, this._width = null, this._items = [], this._clones = [], this._mergers = [], this._invalidated = {}, this._pipe = [], e.each(i.Plugins, e.proxy(function(e, t) {
                this._plugins[e[0].toLowerCase() + e.slice(1)] = new t(this)
            }, this)), e.each(i.Pipe, e.proxy(function(t, n) {
                this._pipe.push({
                    filter: n.filter,
        ...
        function o(e) {
            var t, r, i = n.createElement("div"),
                s = e;
            for (t in s)
                if (r = s[t], "undefined" != typeof i.style[r]) return i = null, [r, t];
            return [!1]
        }
        ...
        h = {
            ...
            run: function() {
                var e, t, n = this._clones,
                    r = this._items,
                    i = this.settings.loop ? n.length - Math.max(2 * this.settings.items, 4) : 0;
                for (e = 0, t = Math.abs(i / 2); t > e; e++) i > 0 ? (this.$stage.children().eq(r.length + n.length - 1).remove(), n.pop(), this.$stage.children().eq(0).remove(), n.pop()) : (n.push(n.length / 2), this.$stage.append(r[n[n.length - 1]].clone().addClass("cloned")), n.push(r.length - 1 - (n.length - 1) / 2), this.$stage.prepend(r[n[n.length - 1]].clone().addClass("cloned")))
            }
        }, {
            filter: ["width", "items", "settings"],
            run: function() {
                var e, t, n, r = this.settings.rtl ? 1 : -1,
                    i = (this.width() / this.settings.items).toFixed(3),
                    s = 0;
                for (this._coordinates = [], t = 0, n = this._clones.length + this._items.length; n > t; t++) e = this._mergers[this.relative(t)], e = this.settings.mergeFit && Math.min(e, this.settings.items) || e, s += (this.settings.autoWidth ? this._items[this.relative(t)].width() + this.settings.margin : i * e) * r, this._coordinates.push(s)
            }
        }, {
            filter: ["width", "items", "settings"],
            run: function() {
                ...
                if (this.$stage.css(i), i = {
                    ...
                    }, i[this.settings.rtl ? "margin-left" : "margin-right"] = this.settings.margin, !this.settings.autoWidth && e.grep(this._mergers, function(e) {
                        return e > 1
                    }).length > 0)
                    for (t = 0, n = this._coordinates.length; n > t; t++) i.width = Math.abs(this._coordinates[t]) - Math.abs(this._coordinates[t - 1] || 0) - this.settings.margin, this.$stage.children().eq(t).css(i);
            ...
            run: function() {
                var e, t, n, r, i = this.settings.rtl ? 1 : -1,
                    ...
                    u = o + this.width() * i,
                    a = [];
                for (n = 0, r = this._coordinates.length; r > n; n++) e = this._coordinates[n - 1] || 0, t = Math.abs(this._coordinates[n]) + s * i, (this.op(e, "<=", o) && this.op(e, ">", u) || this.op(t, "<", o) && this.op(t, ">", u)) && a.push(n);
            ...
            if (this.trigger("initialize"), this.$element.addClass(this.settings.baseClass).addClass(this.settings.themeClass).toggleClass("owl-rtl", this.settings.rtl), this.browserSupport(), this.settings.autoWidth && this.state.imagesLoaded !== !0) {
                var t, n, i;
                if (t = this.$element.find("img"), n = this.settings.nestedItemSelector ? "." + this.settings.nestedItemSelector : r, i = this.$element.children(n).width(), t.length && 0 >= i) return this.preloadAutoWidthImages(t), !1
            }
            ...
            n ? (e.each(n, function(e) {
                t >= e && e > r && (r = Number(e))
            }), i = e.extend({}, this.options, n[r]), delete i.responsive, i.responsiveClass && this.$element.attr("class", function(e, t) {
                return t.replace(/\b owl-responsive-\S+/g, "")
            }).addClass("owl-responsive-" + r)) : i = e.extend({}, this.options), (null === this.settings || this._breakpoint !== r) && (this.trigger("change", {
                property: {
                    name: "settings",
                    value: i
                }
            ...
            var i, o, u, a;
            if (i = r.originalEvent || r || t.event, 3 === i.which || this.state.isTouch) return !1;
            ...
            if (this.state.isTouch) {
                ...
                this.drag.endTime = (new Date).getTime(), r = this.drag.endTime - this.drag.startTime, i = Math.abs(this.drag.distance), (i > 3 || r > 300) && this.removeClick(this.drag.targetEl), s = this.closest(this.drag.updatedX), this.speed(this.settings.dragEndSpeed || this.settings.smartSpeed), this.current(s), this.invalidate("position"), this.update(), this.settings.pullDrag || this.drag.updatedX !== this.coordinates(s) || this.transitionEnd(), this.drag.distance = 0, e(n).off(".owl.dragEvents")
            }
            ...
            return this.settings.freeDrag || e.each(s, e.proxy(function(e, o) {
                return t > o - r && o + r > t ? n = e : this.op(t, "<", o) && this.op(t, ">", s[e + 1] || o - i) && (n = "left" === this.state.direction ? e + 1 : e), -1 === n
            ...
            return !e.isNumeric(t) || 1 > i ? r : t = this._clones.length ? (t % i + i) % i : Math.max(this.minimum(n), Math.min(this.maximum(n), t))
            ...
            if (!s.loop && s.center) t = this._items.length - 1;
                ...
                if (s.loop || s.center) t = this._items.length + s.items;
                    ...
                    for (revert = s.rtl ? 1 : -1, n = this.$stage.width() - this.$element.width();
                        (r = this.coordinates(i)) && !(r * revert >= n);) t = ++i
                }
            ...
            if (this.settings.loop) {
                ...
                u < this.settings.items && a === !1 ? (s = o + this._items.length, this.reset(s)) : u >= f - this.settings.items && a === !0 && (s = o - this._items.length, this.reset(s)), t.clearTimeout(this.e._goToLoop), this.e._goToLoop = t.setTimeout(e.proxy(function() {
                    this.speed(this.duration(this.current(), s + i, r)), this.current(s + i), this.update()
                }, this), 30)
            } else this.speed(this.duration(this.current(), n, r)), this.current(n), this.update()
        }, i.prototype.next = function(e) {
            e = e || !1, this.to(this.relative(this.current()) + 1, e)
        }, i.prototype.prev = function(e) {
            e = e || !1, this.to(this.relative(this.current()) - 1, e)
        }, i.prototype.transitionEnd = function(e) {
            return e !== r && (e.stopPropagation(), (e.target || e.srcElement || e.originalTarget) !== this.$stage.get(0)) ? !1 : (this.state.inMotion = !1, void this.trigger("translated"))
        }, i.prototype.viewport = function() {
            var r;
            if (this.options.responsiveBaseElement !== t) r = e(this.options.responsiveBaseElement).width();
            ...
            n(this.$element.get(0)) || (this.$element.addClass("owl-hidden"), t.clearInterval(this.e._checkVisibile), this.e._checkVisibile = t.setInterval(e.proxy(r, this), 500))
        }, i.prototype.preloadAutoWidthImages = function(t) {
            var n, r, i, s;
            n = 0, r = this, t.each(function(o, u) {
                i = e(u), s = new Image, s.onload = function() {
                    n++, i.attr("src", s.src), i.css("opacity", 1), n >= t.length && (r.state.imagesLoaded = !0, r.initialize())
            ...
            if (this.support3d = f(), this.support3d) {
                ...
                this.transitionEndVendor = e[u()], this.vendorName = this.transformVendor.replace(/Transform/i, ""), this.vendorName = "" !== this.vendorName ? "-" + this.vendorName.toLowerCase() + "-" : ""
            }
    ...
    function(e, t) {
            ...
            this._core = t, this._loaded = [], this._handlers = {
                "initialized.owl.carousel change.owl.carousel": e.proxy(function(t) {
                    if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type))
                        for (var n = this._core.settings, r = n.center && Math.ceil(n.items / 2) || n.items, i = n.center && -1 * r || 0, s = (t.property && t.property.value || this._core.current()) + i, o = this._core.clones().length, u = e.proxy(function(e, t) {
                                this.load(t)
                            }, this); i++ < r;) this.load(o / 2 + this._core.relative(s)), o && e.each(this._core.clones(this._core.relative(s++)), u)
                }, this)
        ...
        n.Defaults = {
            ...
            !i || e.inArray(r.get(0), this._loaded) > -1 || (i.each(e.proxy(function(n, r) {
                ...
                }, this)).attr("src", o) : (i = new Image, i.onload = e.proxy(function() {
                    s.css({
    ...
    function(e, t, n) {
        ...
        r.Defaults = {
            ...
            if (r = o.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/), r[3].indexOf("youtu") > -1) n = "youtube";
            else {
                if (!(r[3].indexOf("vimeo") > -1)) throw new Error("Video URL not supported.");
                n = "vimeo"
            }
            r = r[6], this._videos[o] = {
                type: n,
                id: r,
                width: i,
                height: s
            ...
            var r, i, s, o = n.width && n.height ? 'style="width:' + n.width + "px;height:" + n.height + 'px;"' : "",
                ...
                h = function(e) {
                    i = '<div class="owl-video-play-icon"></div>', r = c.lazyLoad ? '<div class="owl-video-tn ' + l + '" ' + f + '="' + e + '"></div>' : '<div class="owl-video-tn" style="opacity:1;background-image:url(' + e + ')"></div>', t.after(r), t.after(i)
                };
            return t.wrap('<div class="owl-video-wrapper"' + o + "></div>"), this._core.settings.lazyLoad && (f = "data-src", l = "owl-lazy"), u.length ? (h(u.attr(f)), u.remove(), !1) : void("youtube" === n.type ? (s = "http://img.youtube.com/vi/" + n.id + "/hqdefault.jpg", h(s)) : "vimeo" === n.type && e.ajax({
                type: "GET",
            ...
            "youtube" === o.type ? n = '<iframe width="' + u + '" height="' + f + '" src="http://www.youtube.com/embed/' + o.id + "?autoplay=1&v=" + o.id + '" frameborder="0" allowfullscreen></iframe>' : "vimeo" === o.type && (n = '<iframe src="http://player.vimeo.com/video/' + o.id + '?autoplay=1" width="' + u + '" height="' + f + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'), s.addClass("owl-video-playing"), this._playing = s, r = e('<div style="height:' + f + "px; width:" + u + 'px" class="owl-video-frame">' + n + "</div>"), i.after(r)
        }, r.prototype.isInFullScreen = function() {
            var r = n.fullscreenElement || n.mozFullScreenElement || n.webkitFullscreenElement;
            return r && e(r).parent().hasClass("owl-video-frame") && (this._core.speed(0), this._fullscreen = !0), r && this._fullscreen && this._playing ? !1 : this._fullscreen ? (this._fullscreen = !1, !1) : this._playing && this._core.state.orientation !== t.orientation ? (this._core.state.orientation = t.orientation, !1) : !0
    ...
    function(e, t, n, r) {
        var i = function(t) {
            this.core = t, this.core.options = e.extend({}, i.Defaults, this.core.options), this.swapping = !0, this.previous = r, this.next = r, this.handlers = {
        ...
        i.Defaults = {
            ...
            if (1 === this.core.settings.items && this.core.support3d) {
                ...
                this.core.current() !== this.previous && (o && (t = this.core.coordinates(this.previous) - this.core.coordinates(this.next), r.css({
                    left: t + "px"
                }).addClass("animated owl-animated-out").addClass(o).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", n)), s && i.addClass("animated owl-animated-in").addClass(s).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", n))
            }
    ...
    function(e, t, n) {
        var r = function(t) {
            this.core = t, this.core.options = e.extend({}, r.Defaults, this.core.options), this.handlers = {
    ...
    function(e) {
        ...
        t.Defaults = {
            ...
            }, this)), t = r.navContainer ? e(r.navContainer) : e("<div>").addClass(r.navContainerClass).prependTo(this._controls.$container), this._controls.$next = e("<" + r.navElement + ">"), this._controls.$previous = this._controls.$next.clone(), this._controls.$previous.addClass(r.navClass[0]).html(r.navText[0]).hide().prependTo(t).on("click", e.proxy(function() {
                this.prev(r.navSpeed)
            }, this)), this._controls.$next.addClass(r.navClass[1]).html(r.navText[1]).hide().appendTo(t).on("click", e.proxy(function() {
            ...
            if ("page" !== r.slideBy && (r.slideBy = Math.min(r.slideBy, r.items)), r.dots || "page" == r.slideBy)
                for (this._pages = [], e = i, t = 0, n = 0; s > e; e++)(t >= o || 0 === t) && (this._pages.push({
                    start: e - i,
                    end: e - i + o - 1
            ...
            if (!i.nav || i.loop || i.navRewind || (this._controls.$previous.toggleClass("disabled", 0 >= s), this._controls.$next.toggleClass("disabled", s >= this._core.maximum())), this._controls.$previous.toggle(i.nav), this._controls.$next.toggle(i.nav), i.dots) {
                if (t = this._pages.length - this._controls.$indicators.children().length, i.dotData && 0 !== t) {
                    for (n = 0; n < this._controls.$indicators.children().length; n++) r += this._templates[this._core.relative(n)];
                    this._controls.$indicators.html(r)
                } else t > 0 ? (r = (new Array(t + 1)).join(this._templates[0]), this._controls.$indicators.append(r)) : 0 > t && this._controls.$indicators.children().slice(t).remove();
            ...
            var i;
            r ? e.proxy(this._overrides.to, this._core)(t, n) : (i = this._pages.length, e.proxy(this._overrides.to, this._core)(this._pages[(t % i + i) % i].start, n))
    ...
    function(e, t) {
    ...
    }(window.Zepto || window.jQuery, window, document), define("owl", function() {}), ! function(e) {
        function t(e) {
            var t = e.length,
                r = n.type(e);
        ...
        if (!e.jQuery) {
            ...
            n.isWindow = function(e) {
                ...
                if (r) {
                    if (u)
                        for (; o > s && (i = n.apply(e[s], r), i !== !1); s++);
                    else
                        for (s in e)
                            if (i = n.apply(e[s], r), i === !1) break
                } else if (u)
                    for (; o > s && (i = n.call(e[s], s, e[s]), i !== !1); s++);
                else
                    for (s in e)
                        if (i = n.call(e[s], s, e[s]), i === !1) break;
                return e
                ...
                var e, t, r, i, s, o, u = arguments[0] || {},
                    ...
                    f = arguments.length,
                    l = !1;
                for ("boolean" == typeof u && (l = u, u = arguments[a] || {}, a++), "object" != typeof u && "function" !== n.type(u) && (u = {}), a === f && (u = this, a--); f > a; a++)
                    if (null != (s = arguments[a]))
                        for (i in s) e = u[i], r = s[i], u !== r && (l && r && (n.isPlainObject(r) || (t = n.isArray(r))) ? (t ? (t = !1, o = e && n.isArray(e) ? e : []) : o = e && n.isPlainObject(e) ? e : {}, u[i] = n.extend(l, o, r)) : void 0 !== r && (u[i] = r));
                return u
            ...
            for (var i = {}, s = i.hasOwnProperty, o = i.toString, u = "Boolean Number String Function Array Date RegExp Object Error".split(" "), a = 0; a < u.length; a++) i["[object " + u[a] + "]"] = u[a].toLowerCase();
    ...
    function(e) {
        ...
        return function(e, t, n, r) {
            ...
            function a(e, n, r, i) {
                ...
                function h(t, n, i) {
                    var s, o, u = 0;
                    do o = n + (i - n) / 2, s = a(o, e, r) - t, s > 0 ? i = o : n = o; while (Math.abs(s) > g && ++u < y);
                    return o
                }
                ...
                var x = E ? new Float32Array(b) : new Array(b),
                    T = !1,
                    N = function(t) {
                        return T || d(), e === n && r === i ? t : 0 === t ? 0 : 1 === t ? 1 : a(p(t), n, i)
                    };
            ...
            function f(e, t) {
                var n = e;
                return d.isString(e) ? b.Easings[e] || (n = !1) : n = d.isArray(e) && 1 === e.length ? u.apply(null, e) : d.isArray(e) && 2 === e.length ? w.apply(null, e.concat([t])) : d.isArray(e) && 4 === e.length ? a.apply(null, e) : !1, n === !1 && (n = b.Easings[b.defaults.easing] ? b.defaults.easing : y), n
            }

            function l(e) {
                if (e)
                    for (var t = (new Date).getTime(), n = 0, i = b.State.calls.length; i > n; n++)
                        if (b.State.calls[n]) {
                            ...
                            for (var h = Math.min((t - f) / a.duration, 1), p = 0, m = u.length; m > p; p++) {
                                var g = u[p],
                                    y = g.element;
                                if (o(y)) {
                                    var w = !1;
                                    ...
                                    a.visibility && "hidden" !== a.visibility && E.setPropertyValue(y, "visibility", a.visibility);
                                    for (var T in g)
                                        if ("element" !== T) {
                                            var N = g[T],
                                                C, k = d.isString(N.easing) ? b.Easings[N.easing] : N.easing;
                                            if (C = 1 === h ? N.endValue : N.startValue + (N.endValue - N.startValue) * k(h), N.currentValue = C, E.Hooks.registered[T]) {
                                                var L = E.Hooks.getRoot(T),
                                                    A = o(y).rootPropertyValueCache[L];
                                                A && (N.rootPropertyValue = A)
                                            }
                                            var O = E.setPropertyValue(y, T, N.currentValue + (0 === parseFloat(C) ? "" : N.unitType), N.rootPropertyValue, N.scrollData);
                                            E.Hooks.registered[T] && (o(y).rootPropertyValueCache[L] = E.Normalizations.registered[L] ? E.Normalizations.registered[L]("extract", null, O[1]) : O[1]), "transform" === O[0] && (w = !0)
                                        }
                                    a.mobileHA && o(y).transformCache.translate3d === r && (o(y).transformCache.translate3d = "(0px, 0px, 0px)", w = !0), w && E.flushTransformCache(y)
                                }
                            }
                            a.display !== r && "none" !== a.display && (b.State.calls[n][2].display = !1), a.visibility && "hidden" !== a.visibility && (b.State.calls[n][2].visibility = !1), a.progress && a.progress.call(s[1], s[1], h, Math.max(0, f + a.duration - t), f), 1 === h && c(n)
                        }
            ...
            function c(e, t) {
                ...
                for (var n = b.State.calls[e][0], i = b.State.calls[e][1], s = b.State.calls[e][2], u = b.State.calls[e][4], a = !1, f = 0, l = n.length; l > f; f++) {
                    var c = n[f].element;
                    if (t || s.loop || ("none" === s.display && E.setPropertyValue(c, "display", s.display), "hidden" === s.visibility && E.setPropertyValue(c, "visibility", s.visibility)), (v.queue(c)[1] === r || !/\.velocityQueueEntryFlag/i.test(v.queue(c)[1])) && o(c)) {
                        o(c).isAnimating = !1, o(c).rootPropertyValueCache = {};
                        var h = !1;
                        v.each(E.Lists.transforms3D, function(e, t) {
                            var n = /^scale/.test(t) ? 1 : 0,
                                i = o(c).transformCache[t];
                            o(c).transformCache[t] !== r && (new RegExp("^\\(" + n + "[^.]")).test(i) && (h = !0, delete o(c).transformCache[t])
                        }), s.mobileHA && (h = !0, delete o(c).transformCache.translate3d), h && E.flushTransformCache(c), E.Values.removeClass(c, "velocity-animating")
                    }
                    if (!t && s.complete && !s.loop && f === l - 1) try {
                        s.complete.call(i, i)
                    } catch (p) {
                        setTimeout(function() {
                            throw p
                    ...
                    u && s.loop !== !0 && u(i), s.loop !== !0 || t || (v.each(o(c).tweensContainer, function(e, t) {
                ...
                a === !1 && (b.State.isTicking = !1, delete b.State.calls, b.State.calls = [])
            }
            var h = function() {
                ...
                v, m = !1;
            if (e.fn && e.fn.jquery ? (v = e, m = !0) : v = t.Velocity.Utilities, 8 >= h && !m) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
            ...
            var w = function() {
                ...
                return function r(e, t, i) {
                    var s = {
                        ...
                        f = .016,
                        l, c, h;
                    for (e = parseFloat(e) || 500, t = parseFloat(t) || 20, i = i || null, s.tension = e, s.friction = t, l = null !== i, l ? (u = r(e, t), c = u / i * f) : c = f;;)
                        if (h = n(h || s, c), o.push(1 + h.x), u += 16, !(Math.abs(h.x) > a && Math.abs(h.v) > a)) break;
                    return l ? function(e) {
            ...
            var E = b.CSS = {
                ...
                Hooks: {
                    ...
                    registered: {},
                    register: function() {
                        for (var e = 0; e < E.Lists.colors.length; e++) E.Hooks.templates[E.Lists.colors[e]] = ["Red Green Blue Alpha", "255 255 255 1"];
                        var t, n, r;
                        if (h)
                            for (t in E.Hooks.templates) {
                                n = E.Hooks.templates[t], r = n[0].split(" ");
                                var i = n[1].match(E.RegEx.valueSplit);
                                "Color" === r[0] && (r.push(r.shift()), i.push(i.shift()), E.Hooks.templates[t] = [r.join(" "), i.join(" ")])
                            }
                        for (t in E.Hooks.templates) {
                            n = E.Hooks.templates[t], r = n[0].split(" ");
                            for (var e in r) {
                    ...
                    cleanRootPropertyValue: function(e, t) {
                        return E.RegEx.valueUnwrap.test(t) && (t = t.match(E.Hooks.RegEx.valueUnwrap)[1]), E.Values.isCSSNullValue(t) && (t = E.Hooks.templates[e][1]), t
                    },
                    extractValue: function(e, t) {
                        ...
                        if (n) {
                            var r = n[0],
                                i = n[1];
                            return t = E.Hooks.cleanRootPropertyValue(r, t), t.toString().match(E.RegEx.valueSplit)[i]
                        }
                        return t
                    },
                    injectValue: function(e, t, n) {
                        ...
                        if (r) {
                            var i = r[0],
                                s = r[1],
                                o, u;
                            return n = E.Hooks.cleanRootPropertyValue(i, n), o = n.toString().match(E.RegEx.valueSplit), o[s] = t, u = o.join(" ")
                        }
                        return n
                    }
                },
                Normalizations: {
                    ...
                    register: function() {
                        9 >= h || b.State.isGingerbread || (E.Lists.transformsBase = E.Lists.transformsBase.concat(E.Lists.transforms3D));
                        for (var e = 0; e < E.Lists.transformsBase.length; e++) ! function() {
                        ...
                        for (var e = 0; e < E.Lists.colors.length; e++) ! function() {
                                ...
                                switch (e) {
                                    ...
                                    case "extract":
                                        ...
                                        if (E.RegEx.wrappedValueAlreadyExtracted.test(i)) s = i;
                                            ...
                                            /^[A-z]+$/i.test(i) ? o = u[i] !== r ? u[i] : u.black : E.RegEx.isHex.test(i) ? o = "rgb(" + E.Values.hexToRgb(i).join(" ") + ")" : /^rgba?\(/i.test(i) || (o = u.black), s = (o || i).toString().match(E.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                        }
                                        return 8 >= h || 3 !== s.split(" ").length || (s += " 1"), s;
                                    case "inject":
                ...
                getPropertyValue: function(e, n, i, s) {
                    function u(e, n) {
                        ...
                        if (8 >= h) a = v.css(e, n);
                            ...
                            var f = !1;
                            if (/^(width|height)$/.test(n) && 0 === E.getPropertyValue(e, "display") && (f = !0, E.setPropertyValue(e, "display", E.Values.getDisplayType(e))), !s) {
                                if ("height" === n && "border-box" !== E.getPropertyValue(e, "boxSizing").toString().toLowerCase()) {
                                    var l = e.offsetHeight - (parseFloat(E.getPropertyValue(e, "borderTopWidth")) || 0) - (parseFloat(E.getPropertyValue(e, "borderBottomWidth")) || 0) - (parseFloat(E.getPropertyValue(e, "paddingTop")) || 0) - (parseFloat(E.getPropertyValue(e, "paddingBottom")) || 0);
                                    return i(), l
                                }
                                if ("width" === n && "border-box" !== E.getPropertyValue(e, "boxSizing").toString().toLowerCase()) {
                                    var c = e.offsetWidth - (parseFloat(E.getPropertyValue(e, "borderLeftWidth")) || 0) - (parseFloat(E.getPropertyValue(e, "borderRightWidth")) || 0) - (parseFloat(E.getPropertyValue(e, "paddingLeft")) || 0) - (parseFloat(E.getPropertyValue(e, "paddingRight")) || 0);
                                    return i(), c
                                }
                            }
                            var p;
                            p = o(e) === r ? t.getComputedStyle(e, null) : o(e).computedStyle ? o(e).computedStyle : o(e).computedStyle = t.getComputedStyle(e, null), (h || b.State.isFirefox) && "borderColor" === n && (n = "borderTopColor"), a = 9 === h && "filter" === n ? p.getPropertyValue(n) : p[n], ("" === a || null === a) && (a = e.style[n]), i()
                        }
                        if ("auto" === a && /^(top|right|bottom|left)$/i.test(n)) {
                            var d = u(e, "position");
                            ("fixed" === d || "absolute" === d && /top|left/i.test(n)) && (a = v(e).position()[n] + "px")
                        }
                        return a
                    }
                    var a;
                    if (E.Hooks.registered[n]) {
                        var f = n,
                            l = E.Hooks.getRoot(f);
                        i === r && (i = E.getPropertyValue(e, E.Names.prefixCheck(l)[0])), E.Normalizations.registered[l] && (i = E.Normalizations.registered[l]("extract", e, i)), a = E.Hooks.extractValue(f, i)
                    } else if (E.Normalizations.registered[n]) {
                        var c, p;
                        c = E.Normalizations.registered[n]("name", e), "transform" !== c && (p = u(e, E.Names.prefixCheck(c)[0]), E.Values.isCSSNullValue(p) && E.Hooks.templates[n] && (p = E.Hooks.templates[n][1])), a = E.Normalizations.registered[n]("extract", e, p)
                    }
                    return /^[\d-]/.test(a) || (a = o(e) && o(e).isSVG && E.Names.SVGAttribute(n) ? /^(height|width)$/i.test(n) ? e.getBBox()[n] : e.getAttribute(n) : u(e, E.Names.prefixCheck(n)[0])), E.Values.isCSSNullValue(a) && (a = 0), b.debug >= 2 && console.log("Get " + n + ": " + a), a
                },
                setPropertyValue: function(e, n, r, i, s) {
                    ...
                    else if (E.Normalizations.registered[n] && "transform" === E.Normalizations.registered[n]("name", e)) E.Normalizations.registered[n]("inject", e, r), u = "transform", r = o(e).transformCache[n];
                    else {
                        if (E.Hooks.registered[n]) {
                            var a = n,
                                f = E.Hooks.getRoot(n);
                            i = i || E.getPropertyValue(e, f), r = E.Hooks.injectValue(a, r, i), n = f
                        }
                        if (E.Normalizations.registered[n] && (r = E.Normalizations.registered[n]("inject", e, r), n = E.Normalizations.registered[n]("name", e)), u = E.Names.prefixCheck(n)[0], 8 >= h) try {
                            e.style[u] = r
                        } catch (l) {
                            b.debug && console.log("Browser does not support [" + r + "] for [" + u + "]")
                        } else o(e) && o(e).isSVG && E.Names.SVGAttribute(n) ? e.setAttribute(n, r) : e.style[u] = r;
                ...
                flushTransformCache: function(e) {
                    ...
                    if ((h || b.State.isAndroid && !b.State.isChrome) && o(e).isSVG) {
                        ...
                        v.each(o(e).transformCache, function(t) {
                            return i = o(e).transformCache[t], "transformPerspective" === t ? (s = i, !0) : (9 === h && "rotateZ" === t && (t = "rotate"), void(n += t + i + " "))
                        }), s && (n = "perspective" + s + " " + n)
                    }
                    E.setPropertyValue(e, "transform", n)
                }
            };
            E.Hooks.register(), E.Normalizations.register(), b.hook = function(e, t, n) {
                var i = r;
                return e = s(e), v.each(e, function(e, s) {
            ...
            var S = function() {
                ...
                function u() {
                    function e(e) {
                        function h(e, t) {
                            var n = r,
                                i = r,
                                o = r;
                            return d.isArray(e) ? (n = e[0], !d.isArray(e[1]) && /^[\d-]/.test(e[1]) || d.isFunction(e[1]) || E.RegEx.isHex.test(e[1]) ? o = e[1] : (d.isString(e[1]) && !E.RegEx.isHex.test(e[1]) || d.isArray(e[1])) && (i = t ? e[1] : f(e[1], u.duration), e[2] !== r && (o = e[2]))) : n = e, t || (i = i || u.easing), d.isFunction(n) && (n = n.call(s, N, T)), d.isFunction(o) && (o = o.call(s, N, T)), [n || 0, i, o]
                        }
                        ...
                        function m() {
                            var e = {
                                ...
                                r = e.position === H.lastPosition && e.myParent === H.lastParent,
                                i = e.fontSize === H.lastFontSize;
                            H.lastParent = e.myParent, H.lastPosition = e.position, H.lastFontSize = e.fontSize;
                            var u = 100,
                                a = {};
                            if (i && r) a.emToPx = H.lastEmToPx, a.percentToPxWidth = H.lastPercentToPxWidth, a.percentToPxHeight = H.lastPercentToPxHeight;
                            else {
                                var f = o(s).isSVG ? n.createElementNS("http://www.w3.org/2000/svg", "rect") : n.createElement("div");
                                b.init(f), e.myParent.appendChild(f), v.each(["overflow", "overflowX", "overflowY"], function(e, t) {
                                    b.CSS.setPropertyValue(f, t, "hidden")
                                }), b.CSS.setPropertyValue(f, "position", e.position), b.CSS.setPropertyValue(f, "fontSize", e.fontSize), b.CSS.setPropertyValue(f, "boxSizing", "content-box"), v.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function(e, t) {
                            ...
                            return null === H.remToPx && (H.remToPx = parseFloat(E.getPropertyValue(n.body, "fontSize")) || 16), null === H.vwToPx && (H.vwToPx = parseFloat(t.innerWidth) / 100, H.vhToPx = parseFloat(t.innerHeight) / 100), a.remToPx = H.remToPx, a.vwToPx = H.vwToPx, a.vhToPx = H.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(a), s), a
                        }
                        if (u.begin && 0 === N) try {
                            u.begin.call(y, y)
                        } catch (g) {
                        ...
                        if ("scroll" === A) {
                            ...
                            u.container ? d.isWrapped(u.container) || d.isNode(u.container) ? (u.container = u.container[0] || u.container, k = u.container["scroll" + S], M = k + v(s).position()[S.toLowerCase()] + C) : u.container = null : (k = b.State.scrollAnchor[b.State["scrollProperty" + S]], O = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === S ? "Top" : "Left")]], M = v(s).offset()[S.toLowerCase()] + C), a = {
                                ...
                                element: s
                            }, b.debug && console.log("tweensContainer (scroll): ", a.scroll, s)
                        } else if ("reverse" === A) {
                            if (!o(s).tweensContainer) return void v.dequeue(s, u.queue);
                            "none" === o(s).opts.display && (o(s).opts.display = "auto"), "hidden" === o(s).opts.visibility && (o(s).opts.visibility = "visible"), o(s).opts.loop = !1, o(s).opts.begin = null, o(s).opts.complete = null, x.easing || delete u.easing, x.duration || delete u.duration, u = v.extend({}, o(s).opts, u);
                            var _ = v.extend(!0, {}, o(s).tweensContainer);
                            for (var D in _)
                                if ("element" !== D) {
                                    var P = _[D].startValue;
                                    _[D].startValue = _[D].currentValue = _[D].endValue, _[D].endValue = P, d.isEmptyObject(x) || (_[D].easing = u.easing), b.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(_[D]), s)
                                }
                            a = _
                        } else if ("start" === A) {
                            var _;
                            o(s).tweensContainer && o(s).isAnimating === !0 && (_ = o(s).tweensContainer), v.each(w, function(e, t) {
                                if (RegExp("^" + E.Lists.colors.join("$|^") + "$").test(e)) {
                                    ...
                                    if (E.RegEx.isHex.test(i)) {
                                        for (var u = ["Red", "Green", "Blue"], a = E.Values.hexToRgb(i), f = o ? E.Values.hexToRgb(o) : r, l = 0; l < u.length; l++) w[e + u[l]] = [a[l], s, f ? f[l] : f];
                                        delete w[e]
                                    }
                                }
                            });
                            for (var j in w) {
                                ...
                                var U = E.Hooks.getRoot(j),
                                    z = !1;
                                if (o(s).isSVG || E.Names.prefixCheck(U)[1] !== !1 || E.Normalizations.registered[U] !== r) {
                                    ...
                                    var W, X, J, K = !1;
                                    if (W = p(j, R), R = W[0], J = W[1], W = p(j, I), I = W[0].replace(/^([+-\/*])=/, function(e, t) {
                                            return K = t, ""
                                        }), X = W[1], R = parseFloat(R) || 0, I = parseFloat(I) || 0, "%" === X && (/^(fontSize|lineHeight)$/.test(j) ? (I /= 100, X = "em") : /^scale/.test(j) ? (I /= 100, X = "") : /(Red|Green|Blue)$/i.test(j) && (I = I / 100 * 255, X = "")), /[\/*]/.test(K)) X = J;
                                    else if (J !== X && 0 !== R)
                                        if (0 === I) X = J;
                                        else {
                                            c = c || m();
                                            ...
                                            switch (J) {
                                                case "%":
                                                    R *= "x" === Q ? c.percentToPxWidth : c.percentToPxHeight;
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                            ...
                                            switch (X) {
                                                case "%":
                                                    R *= 1 / ("x" === Q ? c.percentToPxWidth : c.percentToPxHeight);
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                    ...
                                    a[j] = {
                                        ...
                                        unitType: X,
                                        easing: q
                                    }, b.debug && console.log("tweensContainer (" + j + "): " + JSON.stringify(a[j]), s)
                                } else b.debug && console.log("Skipping [" + U + "] due to a lack of browser support.")
                            }
                            a.element = s
                        }
                        a.element && (E.Values.addClass(s, "velocity-animating"), B.push(a), "" === u.queue && (o(s).tweensContainer = a, o(s).opts = u), o(s).isAnimating = !0, N === T - 1 ? (b.State.calls.length > 1e4 && (b.State.calls = i(b.State.calls)), b.State.calls.push([B, y, u, null, L.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, l())) : N++)
                    }
                    var s = this,
                        u = v.extend({}, b.defaults, x),
                        a = {},
                        c;
                    if (o(s) === r && b.init(s), parseFloat(u.delay) && u.queue !== !1 && v.queue(s, u.queue, function(e) {
                            b.velocityQueueEntryFlag = !0, o(s).delayTimer = {
                                setTimeout: setTimeout(e, parseFloat(u.delay)),
                                next: e
                            }
                        }), b.mock === !0) u.duration = 1;
                    ...
                    u.easing = f(u.easing, u.duration), u.begin && !d.isFunction(u.begin) && (u.begin = null), u.progress && !d.isFunction(u.progress) && (u.progress = null), u.complete && !d.isFunction(u.complete) && (u.complete = null), u.display !== r && null !== u.display && (u.display = u.display.toString().toLowerCase(), "auto" === u.display && (u.display = b.CSS.Values.getDisplayType(s))), u.visibility && (u.visibility = u.visibility.toString().toLowerCase()), u.mobileHA = u.mobileHA && b.State.isMobile && !b.State.isGingerbread, u.queue === !1 ? u.delay ? setTimeout(e, u.delay) : e() : v.queue(s, u.queue, function(t, n) {
                        return n === !0 ? (L.promise && L.resolver(y), !0) : (b.velocityQueueEntryFlag = !0, void e(t))
                    }), "" !== u.queue && "fx" !== u.queue || "inprogress" === v.queue(s)[0] || v.dequeue(s)
                }
                var a = arguments[0] && (v.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || d.isString(arguments[0].properties)),
                    h, p, m, y, w, x;
                if (d.isWrapped(this) ? (h = !1, m = 0, y = this, p = this) : (h = !0, m = 1, y = a ? arguments[0].elements : arguments[0]), y = s(y)) {
                    a ? (w = arguments[0].properties, x = arguments[0].options) : (w = arguments[m], x = arguments[m + 1]);
                    var T = y.length,
                        N = 0;
                    if ("stop" !== w && !v.isPlainObject(x)) {
                        var C = m + 1;
                        x = {};
                        for (var k = C; k < arguments.length; k++) d.isArray(arguments[k]) || !/fast|normal|slow/i.test(arguments[k].toString()) && !/^\d/.test(arguments[k]) ? d.isString(arguments[k]) || d.isArray(arguments[k]) ? x.easing = arguments[k] : d.isFunction(arguments[k]) && (x.complete = arguments[k]) : x.duration = arguments[k]
                    }
                    var L = {
                        promise: null,
                        resolver: null,
                    ...
                    h && b.Promise && (L.promise = new b.Promise(function(e, t) {
                    ...
                    switch (w) {
                        ...
                        case "stop":
                            ...
                            return v.each(b.State.calls, function(e, t) {
                                t && v.each(t[1], function(n, i) {
                                    var s = d.isString(x) ? x : "";
                                    return x !== r && t[2].queue !== s ? !0 : void v.each(y, function(t, n) {
                                        n === i && (x !== r && (v.each(v.queue(n, s), function(e, t) {
                                            d.isFunction(t) && t(null, !0)
                                        }), v.queue(n, s, [])), o(n) && "" === s && v.each(o(n).tweensContainer, function(e, t) {
                            ...
                            if (!v.isPlainObject(w) || d.isEmptyObject(w)) {
                                if (d.isString(w) && b.Sequences[w]) {
                                    var M = v.extend({}, x),
                                        _ = M.duration,
                                        D = M.delay || 0;
                                    return M.backwards === !0 && (y = y.reverse()), v.each(y, function(e, t) {
                                        parseFloat(M.stagger) ? M.delay = D + parseFloat(M.stagger) * e : d.isFunction(M.stagger) && (M.delay = D + M.stagger.call(t, e, T)), M.drag && (M.duration = parseFloat(_) || (/^(callout|transition)/.test(w) ? 1e3 : g), M.duration = Math.max(M.duration * (M.backwards ? 1 - e / T : (e + 1) / T), .75 * M.duration, 200)), b.Sequences[w].call(t, t, M || {}, e, T, y, L.promise ? L : r)
                                    }), e()
                                }
                                var P = "Velocity: First argument (" + w + ") was not a property map, a known action, or a registered sequence. Aborting.";
                                return L.promise ? L.rejecter(new Error(P)) : console.log(P), e()
                            }
                            A = "start"
                    }
                    var H = {
                    ...
                    if (M.loop = parseInt(M.loop), j = 2 * M.loop - 1, M.loop)
                        for (var F = 0; j > F; F++) {
                            ...
                            F === j - 1 && (I.display = M.display, I.visibility = M.visibility, I.complete = M.complete), S(y, "reverse", I)
                        }
                    return e()
                }
            };
            ...
            return b.State.isMobile || n.hidden === r || n.addEventListener("visibilitychange", function() {
            ...
            }), e.Velocity = b, e !== t && (e.fn.velocity = S, e.fn.velocity.defaults = b.defaults), v.each(["Down", "Up"], function(e, t) {
                b.Sequences["slide" + t] = function(e, n, i, s, o, u) {
                    var a = v.extend({}, n),
                        ...
                        h = {};
                    a.display === r && (a.display = "Down" === t ? "inline" === b.CSS.Values.getDisplayType(e) ? "inline-block" : "block" : "none"), a.begin = function() {
                        f && f.call(o, o), h.overflow = e.style.overflow, e.style.overflow = "hidden";
                        for (var n in c) {
                            h[n] = e.style[n];
                ...
                b.Sequences["fade" + t] = function(e, n, i, s, o, u) {
                    var a = v.extend({}, n),
                        ...
                        l = a.complete;
                    a.complete = i !== s - 1 ? a.begin = null : function() {
                        l && l.call(o, o), u && u.resolver(o)
                    }, a.display === r && (a.display = "In" === t ? "auto" : "none"), b(this, f, a)
                }
            }), b
        }(window.jQuery || window.Zepto || window, window, document)
    }), ! function(e) {
        "object" == typeof module && "object" == typeof module.exports ? module.exports = e() : "function" == typeof define && define.amd ? define("velocityUi", ["velocity"], e) : e()
    }(function() {
        return function(e, t, n, r) {
            ...
            if (!e.Velocity.version || e.Velocity.version.major <= 0 && e.Velocity.version.minor <= 11 && e.Velocity.version.patch < 8) {
            ...
            e.Velocity.RegisterUI = function(t, n) {
                function i(t, n, r, i) {
                    ...
                    e.Velocity.Utilities.each(t.nodeType ? [t] : t, function(t, n) {
                        i && (r += t * i), o = n.parentNode, e.Velocity.Utilities.each(["height", "paddingTop", "paddingBottom", "marginTop", "marginBottom"], function(t, r) {
                            s += parseFloat(e.Velocity.CSS.getPropertyValue(n, r))
                        })
                    }), e.Velocity.animate(o, {
                        height: ("In" === n ? "+" : "-") + "=" + s
                    }, {
                        queue: !1,
                        easing: "ease-in-out",
                ...
                return e.Velocity.Sequences[t] = function(s, o, u, f, l, c) {
                    function h() {
                        o.display !== r && "none" !== o.display || !/Out$/.test(t) || e.Velocity.Utilities.each(l.nodeType ? [l] : l, function(t, n) {
                            e.Velocity.CSS.setPropertyValue(n, "display", "none")
                        }), o.complete && o.complete.call(l, l), c && c.resolver(l || s)
                    }
                    for (var p = u === f - 1, d = 0; d < n.calls.length; d++) {
                        var v = n.calls[d],
                            ...
                            b = v[2] || {},
                            w = {};
                        if (w.duration = g * (y || 1), w.queue = o.queue || "", w.easing = b.easing || "ease", w.delay = b.delay || 0, w._cacheValues = b._cacheValues || !0, 0 === d) {
                            if (w.delay += o.delay || 0, 0 === u && (w.begin = function() {
                                    o.begin && o.begin.call(l, l);
                                    var e = t.match(/(In|Out)$/);
                                    o.animateParentHeight && e && i(l, e[0], g + w.delay, o.stagger)
                                }), null !== o.display)
                                if (o.display !== r && "none" !== o.display) w.display = o.display;
                                else if (/In$/.test(t)) {
                                var E = e.Velocity.CSS.Values.getDisplayType(s);
                                w.display = "inline" === E ? "inline-block" : E
                            }
                            o.visibility && "hidden" !== o.visibility && (w.visibility = o.visibility)
                        }
                        d === n.calls.length - 1 && (w.complete = function() {
                            if (n.reset) {
                                for (var t in n.reset) {
                                    var r = n.reset[t];
                                    ("string" == typeof r || "number" == typeof r) && (n.reset[t] = [n.reset[t], n.reset[t]])
                                }
                                var i = {
                                    duration: 0,
                                    queue: !1
                        ...
                        }, "hidden" === o.visibility && (w.visibility = o.visibility)), e.Velocity.animate(s, m, w)
                    }
                }, e.Velocity
            ...
            for (var s in e.Velocity.RegisterUI.packagedEffects) e.Velocity.RegisterUI(s, e.Velocity.RegisterUI.packagedEffects[s])
        }(window.jQuery || window.Zepto || window, window, document)
    }), define("modules/sliders", ["jquery", "owl", "velocity", "velocityUi"], function(e, t) {
        var n = {
                owl: e(".slider")
            },
            r = {
                init: function() {
                    n.owl.hasClass("js-main-slider") && e(window).on("pageLoaded", function() {
                        r.animateText.showCurent()
                    }), this.bindOwl(n.owl, n.owl.data("config"))
                },
                bindOwl: function(t, n) {
                    t.owlCarousel(n), t.hasClass("js-main-slider") && r.animateText.afterInit(e(".js-main-slider"))
                },
                animateText: {
                    afterInit: function(e) {
                        e.on("translated.owl.carousel", function(t) {
                            r.animateText.showCurent(e), r.animateText.hideOthers(e)
                        })
                    },
                    hideOthers: function(t) {
                        e(".owl-item:not(.active) .text, .owl-item:not(.active) .button", t).css("opacity", "0")
                    },
                    showCurent: function(t) {
                        var n = e(".owl-item.active", t);
                        e(".text", n).css("opacity") === "0" && e(".text", n).velocity("stop").velocity("transition.slideDownIn", function() {
                            e(".button", n).velocity("stop").velocity("transition.slideDownIn")
                        })
                    }
                }
            };
        ...
        typeof module != "undefined" && module.exports ? module.exports.browser = t() : typeof define == "function" && define.amd ? define("browser", t) : this[e] = t()
    }("bowser", function() {
        function e(e) {
            function n(t) {
                var n = e.match(t);
    ...
    function() {
            ...
            return this.each(function() {
                ...
                i ? u.find("*").addBack().each(function() {
                    ...
                    t.is("img:uncached") && l.push({
                        ...
                        var r, i = t.css(n);
                        if (!i) return !0;
                        for (; r = v.exec(i);) l.push({
                            src: r[2],
                            element: t[0]
                        })
                    }), e.each(p, function(n, r) {
                        var i, s = t.attr(r);
                        return s ? (i = s.split(","), void e.each(i, function(n, r) {
                            r = e.trim(r).split(" ")[0], l.push({
                                src: r,
                                element: t[0]
                            })
                        })) : !0
                    ...
                    var h = new Image,
                        p = "load." + t + " error." + t;
                    e(h).on(p, function v(t) {
                        return o++, r.call(l.element, o, s, "load" == t.type), e(this).off(p, v), o == s ? (n.call(u[0]), !1) : void 0
                    }), h.src = l.src
                })
            })
        }
    }(jQuery), define("waitforimages", function() {}), ! function(e) {
        "function" == typeof define && define.amd ? define("shuffle", ["jquery", "modernizr"], e) : window.Shuffle = e(window.jQuery, window.Modernizr)
    }(function(e, t, n) {
        function r(e) {
        ...
        function i(t, n, r) {
            ...
            r = r || {};
            var f = function() {
                a = r.leading === !1 ? 0 : e.now(), u = null, o = t.apply(i, s), i = s = null
            };
            return function() {
                var l = e.now();
                a || r.leading !== !1 || (a = l);
                var c = n - (l - a);
                return i = this, s = arguments, 0 >= c || c > n ? (clearTimeout(u), u = null, a = l, o = t.apply(i, s), i = s = null) : u || r.trailing === !1 || (u = setTimeout(f, c)), o
            }
        }
        ...
        function o(t, n, r) {
            return setTimeout(e.proxy(t, n), r)
        }
        ...
        function l(e) {
            var t, n, r = e.length;
            if (!r) return e;
            for (; --r;) n = Math.floor(Math.random() * (r + 1)), t = e[n], e[n] = e[r], e[r] = t;
            return e
        }
        if ("object" != typeof t) throw new Error("Shuffle.js requires Modernizr.\nhttp://vestride.github.io/Shuffle/#dependencies");
        var c = t.prefixed("transition"),
            h = t.prefixed("transitionDelay"),
            p = t.prefixed("transitionDuration"),
            d = {
                WebkitTransition: "webkitTransitionEnd",
                transition: "transitionend"
            }[c],
            v = t.prefixed("transform"),
            m = r(v),
            g = t.csstransforms && t.csstransitions,
            y = t.csstransforms3d,
            b = "shuffle",
            w = .3,
            E = "all",
        ...
        var C = 0,
            k = e(window),
            L = function(t, n) {
                n = n || {}, e.extend(this, L.options, n, L.settings), this.$el = e(t), this.element = t, this.unique = "shuffle_" + C++, this._fire(L.EventType.LOADING), this._init(), o(function() {
                    this.initialized = !0, this._fire(L.EventType.DONE)
                }, this, 16)
            };
        return L.EventType = {
            LOADING: "loading",
            ...
            _animations: [],
            styleQueue: []
        }, L.Point = N, L._getItemTransformString = function(e, t) {
            return y ? "translate3d(" + e.x + "px, " + e.y + "px, 0) scale3d(" + t + ", " + t + ", 1)" : "translate(" + e.x + "px, " + e.y + "px) scale(" + t + ")"
        }, L._getNumberStyle = function(t, n) {
            return L._getFloat(e(t).css(n))
        }, L._getInt = function(e) {
            return f(parseInt(e, 10))
        }, L._getFloat = function(e) {
            return f(parseFloat(e))
        }, L._getOuterWidth = function(e, t) {
            var n = e.offsetWidth;
            if (t) {
                var r = L._getNumberStyle(e, "marginLeft"),
                    i = L._getNumberStyle(e, "marginRight");
                n += r + i
            }
            return n
        }, L._getOuterHeight = function(e, t) {
            var n = e.offsetHeight;
            if (t) {
                var r = L._getNumberStyle(e, "marginTop"),
                    i = L._getNumberStyle(e, "marginBottom");
                n += r + i
            }
            return n
        }, L._skipTransition = function(e, t, n) {
            var r = e.style[p];
            e.style[p] = "0ms", t.call(n);
            var i = e.offsetWidth;
            i = null, e.style[p] = r
        }, L.prototype._init = function() {
            this.$items = this._getItems(), this.sizer = this._getElementOption(this.sizer), this.sizer && (this.useSizer = !0), this.$el.addClass(L.ClassName.BASE), this._initItems(), k.on("resize." + b + "." + this.unique, this._getResizeFunction());
            var e = this.$el.css(["position", "overflow"]),
                t = L._getOuterWidth(this.element);
            this._validateStyles(e), this._setColumns(t), this.shuffle(this.group, this.initialSort), this.supported && o(function() {
                this._setTransitions(), this.element.style[c] = "height " + this.speed + "ms " + this.easing
            }, this)
        }, L.prototype._getResizeFunction = function() {
            var t = e.proxy(this._onResize, this);
            return this.throttle ? this.throttle(t, this.throttleTime) : t
        }, L.prototype._getElementOption = function(e) {
            return "string" == typeof e ? this.$el.find(e)[0] || null : e && e.nodeType && 1 === e.nodeType ? e : e && e.jquery ? e[0] : null
        }, L.prototype._validateStyles = function(e) {
            ...
            return this._toggleFilterClasses(n.filtered, n.concealed), this.lastFilter = e, "string" == typeof e && (this.group = e), n.filtered
        }, L.prototype._getFilteredSets = function(t, n) {
            var r = e(),
                i = e();
            return t === E ? r = n : s(n, function(n) {
                var s = e(n);
                this._doesPassFilter(t, s) ? r = r.add(s) : i = i.add(s)
            }, this), {
                filtered: r,
                concealed: i
            }
        }, L.prototype._doesPassFilter = function(t, n) {
            if (e.isFunction(t)) return t.call(n[0], n, this);
            var r = n.data(S),
                i = this.delimeter && !e.isArray(r) ? r.split(this.delimeter) : r;
            return e.inArray(t, i) > -1
        }, L.prototype._toggleFilterClasses = function(e, t) {
            e.removeClass(L.ClassName.CONCEALED).addClass(L.ClassName.FILTERED), t.removeClass(L.ClassName.FILTERED).addClass(L.ClassName.CONCEALED)
        }, L.prototype._initItems = function(e) {
            e = e || this.$items, e.addClass([L.ClassName.SHUFFLE_ITEM, L.ClassName.FILTERED].join(" ")), e.css(this.itemCss).data("point", new N).data("scale", x)
        }, L.prototype._updateItemCount = function() {
            this.visibleItems = this._getFilteredItems().length
        }, L.prototype._setTransition = function(e) {
            e.style[c] = m + " " + this.speed + "ms " + this.easing + ", opacity " + this.speed + "ms " + this.easing
        }, L.prototype._setTransitions = function(e) {
            e = e || this.$items, s(e, function(e) {
                this._setTransition(e)
            }, this)
        }, L.prototype._setSequentialDelay = function(e) {
            this.supported && s(e, function(e, t) {
                e.style[h] = "0ms," + (t + 1) * this.sequentialFadeDelay + "ms"
            }, this)
        }, L.prototype._getItems = function() {
            return this.$el.children(this.itemSelector)
        }, L.prototype._getFilteredItems = function() {
            return this.$items.filter("." + L.ClassName.FILTERED)
        }, L.prototype._getConcealedItems = function() {
            return this.$items.filter("." + L.ClassName.CONCEALED)
        }, L.prototype._getColumnSize = function(t, n) {
            var r;
            return r = e.isFunction(this.columnWidth) ? this.columnWidth(t) : this.useSizer ? L._getOuterWidth(this.sizer) : this.columnWidth ? this.columnWidth : this.$items.length > 0 ? L._getOuterWidth(this.$items[0], !0) : t, 0 === r && (r = t), r + n
        }, L.prototype._getGutterSize = function(t) {
            var n;
            return n = e.isFunction(this.gutterWidth) ? this.gutterWidth(t) : this.useSizer ? L._getNumberStyle(this.sizer, "marginLeft") : this.gutterWidth
        }, L.prototype._setColumns = function(e) {
            var t = e || L._getOuterWidth(this.element),
                n = this._getGutterSize(t),
                r = this._getColumnSize(t, n),
                i = (t + n) / r;
            Math.abs(Math.round(i) - i) < w && (i = Math.round(i)), this.cols = Math.max(Math.floor(i), 1), this.containerWidth = t, this.colWidth = r
        }, L.prototype._setContainerSize = function() {
            this.$el.css("height", this._getContainerSize())
        }, L.prototype._getContainerSize = function() {
            return u(this.positions)
        }, L.prototype._fire = function(e, t) {
            this.$el.trigger(e + "." + b, t && t.length ? t : [this])
        }, L.prototype._resetCols = function() {
            var e = this.cols;
            for (this.positions = []; e--;) this.positions.push(0)
        }, L.prototype._layout = function(e, t) {
            s(e, function(e) {
                this._layoutItem(e, !!t)
            }, this), this._processStyleQueue(), this._setContainerSize()
        }, L.prototype._layoutItem = function(t, n) {
            var r = e(t),
                i = r.data(),
                s = i.point,
                o = i.scale,
                u = {
                    width: L._getOuterWidth(t, !0),
                    height: L._getOuterHeight(t, !0)
                },
                a = this._getItemPosition(u);
            N.equals(s, a) && o === x || (i.point = a, i.scale = x, this.styleQueue.push({
                $item: r,
                point: a,
                scale: x,
                opacity: n ? 0 : 1,
        ...
        }, L.prototype._getItemPosition = function(e) {
            for (var t = this._getColumnSpan(e.width, this.colWidth, this.cols), n = this._getColumnSet(t, this.cols), r = this._getShortColumn(n, this.buffer), i = new N(Math.round(this.colWidth * r), Math.round(n[r])), s = n[r] + e.height, o = this.cols + 1 - n.length, u = 0; o > u; u++) this.positions[r + u] = s;
            return i
        }, L.prototype._getColumnSpan = function(e, t, n) {
            var r = e / t;
            return Math.abs(Math.round(r) - r) < w && (r = Math.round(r)), Math.min(Math.ceil(r), n)
        }, L.prototype._getColumnSet = function(e, t) {
            if (1 === e) return this.positions;
            for (var n = t + 1 - e, r = [], i = 0; n > i; i++) r[i] = u(this.positions.slice(i, i + e));
            return r
        }, L.prototype._getShortColumn = function(e, t) {
            for (var n = a(e), r = 0, i = e.length; i > r; r++)
                if (e[r] >= n - t && e[r] <= n + t) return r;
            return 0
        }, L.prototype._shrink = function(t) {
            var n = t || this._getConcealedItems();
            s(n, function(t) {
                var n = e(t),
                    r = n.data();
                r.scale !== T && (r.scale = T, this.styleQueue.push({
                    $item: n,
                    point: r.point,
                    scale: T,
                    opacity: 0,
        ...
        }, L.prototype._onResize = function() {
            if (this.enabled && !this.destroyed && !this.isTransitioning) {
                var e = L._getOuterWidth(this.element);
                e !== this.containerWidth && this.update()
            }
        }, L.prototype._getStylesForTransition = function(e) {
            var t = {
                opacity: e.opacity
            };
            return this.supported ? t[v] = L._getItemTransformString(e.point, e.scale) : (t.left = e.point.x, t.top = e.point.y), t
        }, L.prototype._transition = function(t) {
            var n = this._getStylesForTransition(t);
            this._startItemAnimation(t.$item, n, t.callfront || e.noop, t.callback || e.noop)
        }, L.prototype._startItemAnimation = function(t, n, r, i) {
            function s(t) {
                t.target === t.currentTarget && (e(t.target).off(d, s), i())
            }
            if (r(), !this.initialized) return t.css(n), void i();
            if (this.supported) t.css(n), t.on(d, s);
            else {
                var o = t.stop(!0).animate(n, this.speed, "swing", i);
                this._animations.push(o.promise())
            }
        }, L.prototype._processStyleQueue = function(t) {
            var n = e();
            s(this.styleQueue, function(e) {
                e.skipTransition ? this._styleImmediately(e) : (n = n.add(e.$item), this._transition(e))
            }, this), n.length > 0 && this.initialized ? (this.isTransitioning = !0, this.supported ? this._whenCollectionDone(n, d, this._movementFinished) : this._whenAnimationsDone(this._movementFinished)) : t || o(this._layoutEnd, this), this.styleQueue.length = 0
        }, L.prototype._styleImmediately = function(e) {
            L._skipTransition(e.$item[0], function() {
                e.$item.css(this._getStylesForTransition(e))
            }, this)
        }, L.prototype._movementFinished = function() {
            this.isTransitioning = !1, this._layoutEnd()
        }, L.prototype._layoutEnd = function() {
            this._fire(L.EventType.LAYOUT)
        }, L.prototype._addItems = function(e, t, n) {
            this._initItems(e), this._setTransitions(e), this.$items = this._getItems(), this._shrink(e), s(this.styleQueue, function(e) {
                e.skipTransition = !0
            }), this._processStyleQueue(!0), t ? this._addItemsToEnd(e, n) : this.shuffle(this.lastFilter)
        }, L.prototype._addItemsToEnd = function(e, t) {
            var n = this._filter(null, e),
                r = n.get();
            this._updateItemCount(), this._layout(r, !0), t && this.supported && this._setSequentialDelay(r), this._revealAppended(r)
        }, L.prototype._revealAppended = function(t) {
            o(function() {
                s(t, function(t) {
                    var n = e(t);
                    this._transition({
        ...
        }, L.prototype._whenCollectionDone = function(t, n, r) {
            function i(t) {
                t.target === t.currentTarget && (e(t.target).off(n, i), s++, s === o && r.call(u))
            }
            var s = 0,
                o = t.length,
                u = this;
            t.on(n, i)
        }, L.prototype._whenAnimationsDone = function(t) {
            e.when.apply(null, this._animations).always(e.proxy(function() {
                this._animations.length = 0, t.call(this)
            }, this))
        }, L.prototype.shuffle = function(e, t) {
            this.enabled && !this.isTransitioning && (e || (e = E), this._filter(e), this._updateItemCount(), this._shrink(), this.sort(t))
        }, L.prototype.sort = function(e) {
            ...
            this.update(!0)
        }, L.prototype.appended = function(e, t, n) {
            this._addItems(e, t === !0, n !== !1)
            ...
            function n() {
                t.remove(), this.$items = this._getItems(), this._updateItemCount(), this._fire(L.EventType.REMOVED, [t, this]), t = null
            }
            t.length && t.jquery && (this._toggleFilterClasses(e(), t), this._shrink(t), this.sort(), this.$el.one(L.EventType.LAYOUT + "." + b, e.proxy(n, this)))
        }, L.prototype.destroy = function() {
            k.off("." + this.unique), this.$el.removeClass(b).removeAttr("style").removeData(b), this.$items.removeAttr("style").removeData("point").removeData("scale").removeClass([L.ClassName.CONCEALED, L.ClassName.FILTERED, L.ClassName.SHUFFLE_ITEM].join(" ")), this.$items = null, this.$el = null, this.sizer = null, this.element = null, this.destroyed = !0
        }, e.fn.shuffle = function(t) {
            var n = Array.prototype.slice.call(arguments, 1);
            return this.each(function() {
                var r = e(this),
                    i = r.data(b);
                i ? "string" == typeof t && i[t] && i[t].apply(i, n) : (i = new L(this, t), r.data(b, i))
            })
        }, e.fn.sorted = function(t) {
            var r = e.extend({}, e.fn.sorted.defaults, t),
                i = this.get(),
                s = !1;
            return i.length ? r.randomize ? l(i) : (e.isFunction(r.by) && i.sort(function(t, i) {
                if (s) return 0;
                var o = r.by(e(t)),
                    u = r.by(e(i));
                return o === n && u === n ? (s = !0, 0) : u > o || "sortFirst" === o || "sortLast" === u ? -1 : o > u || "sortLast" === o || "sortFirst" === u ? 1 : 0
            }), s ? this.get() : (r.reverse && i.reverse(), i)) : []
        }, e.fn.sorted.defaults = {
            reverse: !1,
            by: null,
            randomize: !1
        }, L
    }), define("modules/portfolio", ["jquery", "browser", "underscore", "waitforimages", "shuffle"], function(e, t, n) {
        var r = {
                portfolio: e(".portfolio"),
                filter: e(".portfoliofilters"),
                filterbuttons: e(".portfoliofilters .portfoliofilter")
            },
            i = {
                init: function() {
                    if (t.msie) var i = !1;
                    else var i = !0;
                    r.portfolio.waitForImages(function() {
                        r.portfolio.shuffle({
                            itemSelector: ".item",
                            sizer: r.portfolio.find(".sizer"),
                            supported: i
                        })
                    }), e(window).resize(n.debounce(function() {
                        r.portfolio.shuffle("update")
                    }, 1e3)), r.filterbuttons.on("click", function() {
                        if (!e(this).hasClass("active")) {
                            var t = e(this).data("group");
                            r.filter.find(".active").removeClass("active"), e(this).addClass("active"), r.portfolio.shuffle("shuffle", t)
                        }
                    })
                }
            };
        i.init()
    }), define("modules/blog", ["jquery", "shuffle", "underscore", "waitforimages"], function(e, t, n) {
        var r = {
                blog: e(".blog")
            },
            i = {
                init: function() {
                    r.blog.waitForImages(function() {
                        r.blog.shuffle({
                            itemSelector: ".item"
                        })
                    }), e(window).resize(n.debounce(function() {
                        r.blog.shuffle("update")
                    }, 1e3)), e(".metaicons a").click(function(t) {
                        t.preventDefault(), e(this).toggleClass("is-active")
                    })
                }
            };
        r.blog.waitForImages(function() {
    ...
    }), define("modules/quotes", ["jquery", "owl"], function(e, t) {
        var n = {
                testimonials: e(".quotes")
            },
            r = {
                init: function() {
                    n.testimonials.each(function() {
                        var t = e(this).data("config");
                        e(this).owlCarousel(t)
                    })
                }
            };
        r.init()
    }), define("modules/clients", ["jquery", "owl"], function(e, t) {
        var n = {
                clients: e(".clients")
            },
            r = {
                init: function() {
                    n.clients.each(function() {
                        var t = e(this).data("config");
                        e(this).owlCarousel(t)
                    })
                }
        ...
        r.init()
    }), define("modules/testimonials", ["jquery", "owl"], function(e, t) {
        var n = {
        ...
        r.init()
    }), define("modules/staticHeader", ["jquery", "underscore", "waitforimages"], function(e, t) {
        var n = {
                toggle: e(".headertoggle:visible"),
                header: e(".fixedheader"),
                fixed: e(".fixed-screen")
            },
            r = {
                init: function() {
                    e(".js-first-screen").waitForImages(function() {
                        n.toggle.length ? (r.bindToggle(), r.hero(!0)) : r.hero(!1), e(window).resize(t.debounce(function() {
                            n.toggle.length ? r.hero(!0) : r.hero(!1)
                        }, 500))
                    })
                },
                hero: function(t) {
                    var r = e(".js-first-screen"),
                        i = e("header").outerHeight(),
                        s = null;
                    t ? (s = e(window).outerHeight(), r.css("height", s)) : (s = e(window).outerHeight() - i, r.css("height", s), n.fixed.length && e("header").addClass("fixed-screen-header")), n.fixed.length && e(".sections-container").css("padding-top", e(window).outerHeight());
                    if (e(".mainslider").length && e(".owl-item .image", r).length) e(".owl-item .image", r).each(function() {
                        e(this).removeClass("absolute-image");
                        var t = e(this).height();
                        t < r.outerHeight() && e(this).addClass("absolute-image")
                    });
                    else if (e(".cover-el").length) {
                        var o = e(".cover-el"),
                            u = o.height(),
                            a = o.parent().outerHeight();
                        o.removeClass("vertical-align"), u < a && o.addClass("vertical-align")
                    }
                },
                bindToggle: function() {
                    n.toggle.click(function(e) {
                        e.stopPropagation(), n.header.toggleClass("active")
                    }), n.header.click(function(e) {
                        e.stopPropagation()
                    }), e("body, .menu a").click(function() {
        ...
        "function" == typeof define && define.amd ? define("customScroll", ["jquery"], e) : "object" == typeof exports ? module.exports = e : e(jQuery)
    }(function(e) {
        function t(t) {
        ...
        ! function(t) {
            var r = "function" == typeof define && define.amd,
                i = "https:" == n.location.protocol ? "https:" : "http:",
                s = "cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.1.12/jquery.mousewheel.min.js";
            r || e.event.special.mousewheel || e("head").append(decodeURI("%3Cscript src=" + i + "//" + s + "%3E%3C/script%3E")), t()
        }(function() {
            var r = "mCustomScrollbar",
                ...
                u = 0,
                f = {},
                l = t.attachEvent && !t.addEventListener ? 1 : 0,
                c = !1,
                ...
                p = {
                    init: function(t) {
                        var t = e.extend(!0, {}, o, t),
                            n = d.call(this);
                        if (t.live) {
                            var r = t.liveSelector || this.selector || s,
                                a = e(r);
                            if ("off" === t.live) return void m(r);
                            f[r] = setTimeout(function() {
                                a.mCustomScrollbar(t), "once" === t.live && a.length && m(r)
                            }, 500)
                        } else m(r);
                        return t.setWidth = t.set_width ? t.set_width : t.setWidth, t.setHeight = t.set_height ? t.set_height : t.setHeight, t.axis = t.horizontalScroll ? "x" : g(t.axis), t.scrollInertia = t.scrollInertia > 0 && t.scrollInertia < 17 ? 17 : t.scrollInertia, "object" != typeof t.mouseWheel && 1 == t.mouseWheel && (t.mouseWheel = {
                            ...
                            normalizeDelta: !1,
                            invert: !1
                        }), t.mouseWheel.scrollAmount = t.mouseWheelPixels ? t.mouseWheelPixels : t.mouseWheel.scrollAmount, t.mouseWheel.normalizeDelta = t.advanced.normalizeMouseWheelDelta ? t.advanced.normalizeMouseWheelDelta : t.mouseWheel.normalizeDelta, t.scrollButtons.scrollType = y(t.scrollButtons.scrollType), v(t), e(n).each(function() {
                            var n = e(this);
                            if (!n.data(i)) {
                                n.data(i, {
                                    idx: ++u,
                                ...
                                var r = n.data(i),
                                    ...
                                    f = n.data("mcs-theme");
                                o && (s.axis = o), a && (s.scrollbarPosition = a), f && (s.theme = f, v(s)), b.call(this), e("#mCSB_" + r.idx + "_container img:not(." + h[2] + ")").addClass(h[2]), p.update.call(null, n)
                            }
                        })
                    },
                    update: function(t, n) {
                        ...
                        return e(r).each(function() {
                            ...
                            if (t.data(i)) {
                                ...
                                if (!o.length) return;
                                r.tweenRunning && J(t), t.hasClass(h[3]) && t.removeClass(h[3]), t.hasClass(h[4]) && t.removeClass(h[4]), x.call(this), E.call(this), "y" === s.axis || s.advanced.autoExpandHorizontalScroll || o.css("width", w(o.children())), r.overflowed = k.call(this), M.call(this), s.autoDraggerLength && T.call(this), N.call(this), A.call(this);
                                var f = [Math.abs(o[0].offsetTop), Math.abs(o[0].offsetLeft)];
                                "x" !== s.axis && (r.overflowed[0] ? u[0].height() > u[0].parent().height() ? L.call(this) : (K(t, f[0].toString(), {
                                    dir: "y",
                                    dur: 0,
                                    overwrite: "none"
                                }), r.contentReset.y = null) : (L.call(this), "y" === s.axis ? O.call(this) : "yx" === s.axis && r.overflowed[1] && K(t, f[1].toString(), {
                                    dir: "x",
                                    dur: 0,
                                    overwrite: "none"
                                }))), "y" !== s.axis && (r.overflowed[1] ? u[1].width() > u[1].parent().width() ? L.call(this) : (K(t, f[1].toString(), {
                                    dir: "x",
                                    dur: 0,
                                    overwrite: "none"
                                }), r.contentReset.x = null) : (L.call(this), "x" === s.axis ? O.call(this) : "yx" === s.axis && r.overflowed[0] && K(t, f[0].toString(), {
                                    dir: "y",
                                    dur: 0,
                                    overwrite: "none"
                                }))), n && r && (2 === n && s.callbacks.onImageLoad && "function" == typeof s.callbacks.onImageLoad ? s.callbacks.onImageLoad.call(this) : 3 === n && s.callbacks.onSelectorChange && "function" == typeof s.callbacks.onSelectorChange ? s.callbacks.onSelectorChange.call(this) : s.callbacks.onUpdate && "function" == typeof s.callbacks.onUpdate && s.callbacks.onUpdate.call(this)), V.call(this)
                            }
                        })
                    },
                            ...
                            return e(r).each(function() {
                                ...
                                if (r.data(i)) {
                                    var s = r.data(i),
                                        ...
                                        f = e.extend(!0, {}, u, n),
                                        l = W.call(this, t),
                                        c = f.scrollInertia > 0 && f.scrollInertia < 17 ? 17 : f.scrollInertia;
                                    l[0] = X.call(this, l[0], "y"), l[1] = X.call(this, l[1], "x"), f.moveDragger && (l[0] *= s.scrollRatio.y, l[1] *= s.scrollRatio.x), f.dur = c, setTimeout(function() {
                                        null !== l[0] && "undefined" != typeof l[0] && "x" !== o.axis && s.overflowed[0] && (f.dir = "y", f.overwrite = "all", K(r, l[0].toString(), f)), null !== l[1] && "undefined" != typeof l[1] && "y" !== o.axis && s.overflowed[1] && (f.dir = "x", f.overwrite = "none", K(r, l[1].toString(), f))
                                    }, f.timeout)
                                }
                            })
                        }
                    ...
                    disable: function(t) {
                        ...
                        return e(n).each(function() {
                            var n = e(this);
                            n.data(i) && (n.data(i), V.call(this, "remove"), O.call(this), t && L.call(this), M.call(this, !0), n.addClass(h[3]))
                        })
                    },
                    destroy: function() {
                        var t = d.call(this);
                        return e(t).each(function() {
                            ...
                            if (n.data(i)) {
                                var s = n.data(i),
                                    ...
                                    f = e(".mCSB_" + s.idx + "_scrollbar");
                                o.live && m(o.liveSelector || e(t).selector), V.call(this, "remove"), O.call(this), L.call(this), n.removeData(i), Z(this, "mcs"), f.remove(), a.find("img." + h[2]).removeClass(h[2]), u.replaceWith(a.contents()), n.removeClass(r + " _" + i + "_" + s.idx + " " + h[6] + " " + h[7] + " " + h[5] + " " + h[3]).addClass(h[4])
                            }
                        })
                    }
                },
                ...
                v = function(t) {
                    ...
                    t.autoDraggerLength = e.inArray(t.theme, n) > -1 ? !1 : t.autoDraggerLength, t.autoExpandScrollbar = e.inArray(t.theme, r) > -1 ? !1 : t.autoExpandScrollbar, t.scrollButtons.enable = e.inArray(t.theme, i) > -1 ? !1 : t.scrollButtons.enable, t.autoHideScrollbar = e.inArray(t.theme, s) > -1 ? !0 : t.autoHideScrollbar, t.scrollbarPosition = e.inArray(t.theme, o) > -1 ? "outside" : t.scrollbarPosition
                },
                m = function(e) {
                    f[e] && (clearTimeout(f[e]), Z(f, e))
                },
                g = function(e) {
                ...
                b = function() {
                    var t = e(this),
                        n = t.data(i),
                        s = n.opt,
                        o = s.autoExpandScrollbar ? " " + h[1] + "_expand" : "",
                        u = ["<div id='mCSB_" + n.idx + "_scrollbar_vertical' class='mCSB_scrollTools mCSB_" + n.idx + "_scrollbar mCS-" + s.theme + " mCSB_scrollTools_vertical" + o + "'><div class='" + h[12] + "'><div id='mCSB_" + n.idx + "_dragger_vertical' class='mCSB_dragger' style='position:absolute;' oncontextmenu='return false;'><div class='mCSB_dragger_bar' /></div><div class='mCSB_draggerRail' /></div></div>", "<div id='mCSB_" + n.idx + "_scrollbar_horizontal' class='mCSB_scrollTools mCSB_" + n.idx + "_scrollbar mCS-" + s.theme + " mCSB_scrollTools_horizontal" + o + "'><div class='" + h[12] + "'><div id='mCSB_" + n.idx + "_dragger_horizontal' class='mCSB_dragger' style='position:absolute;' oncontextmenu='return false;'><div class='mCSB_dragger_bar' /></div><div class='mCSB_draggerRail' /></div></div>"],
                        a = "yx" === s.axis ? "mCSB_vertical_horizontal" : "x" === s.axis ? "mCSB_horizontal" : "mCSB_vertical",
                        f = "yx" === s.axis ? u[0] + u[1] : "x" === s.axis ? u[1] : u[0],
                        l = "yx" === s.axis ? "<div id='mCSB_" + n.idx + "_container_wrapper' class='mCSB_container_wrapper' />" : "",
                        c = s.autoHideScrollbar ? " " + h[6] : "",
                        p = "x" !== s.axis && "rtl" === n.langDir ? " " + h[7] : "";
                    s.setWidth && t.css("width", s.setWidth), s.setHeight && t.css("height", s.setHeight), s.setLeft = "y" !== s.axis && "rtl" === n.langDir ? "989999px" : s.setLeft, t.addClass(r + " _" + i + "_" + n.idx + c + p).wrapInner("<div id='mCSB_" + n.idx + "' class='mCustomScrollBox mCS-" + s.theme + " " + a + "'><div id='mCSB_" + n.idx + "_container' class='mCSB_container' style='position:relative; top:" + s.setTop + "; left:" + s.setLeft + ";' dir=" + n.langDir + " /></div>");
                    var d = e("#mCSB_" + n.idx),
                        v = e("#mCSB_" + n.idx + "_container");
                    "y" === s.axis || s.advanced.autoExpandHorizontalScroll || v.css("width", w(v.children())), "outside" === s.scrollbarPosition ? ("static" === t.css("position") && t.css("position", "relative"), t.css("overflow", "visible"), d.addClass("mCSB_outside").after(f)) : (d.addClass("mCSB_inside").append(f), v.wrap(l)), S.call(this);
                ...
                E = function() {
                    ...
                    r.advanced.autoExpandHorizontalScroll && "y" !== r.axis && s.css({
                        position: "absolute",
                        width: "auto"
                ...
                S = function() {
                    var t = e(this),
                        n = t.data(i),
                        r = n.opt,
                        s = e(".mCSB_" + n.idx + "_scrollbar:first"),
                        o = nt(r.scrollButtons.tabindex) ? "tabindex='" + r.scrollButtons.tabindex + "'" : "",
                        u = ["<a href='#' class='" + h[13] + "' oncontextmenu='return false;' " + o + " />", "<a href='#' class='" + h[14] + "' oncontextmenu='return false;' " + o + " />", "<a href='#' class='" + h[15] + "' oncontextmenu='return false;' " + o + " />", "<a href='#' class='" + h[16] + "' oncontextmenu='return false;' " + o + " />"],
                        a = ["x" === r.axis ? u[2] : u[0], "x" === r.axis ? u[3] : u[1], u[2], u[3]];
                    r.scrollButtons.enable && s.prepend(a[0]).append(a[1]).next(".mCSB_scrollTools").prepend(a[2]).append(a[3])
                },
                x = function() {
                    var t = e(this),
                        n = t.data(i),
                        ...
                        u = t.css("box-sizing");
                    if ("none" !== s) {
                        var a = o ? t.parent().height() * parseInt(s) / 100 : parseInt(s);
                        "border-box" === u && (a -= t.innerHeight() - t.height() + (t.outerHeight() - t.innerHeight())), r.css("max-height", Math.round(a))
                    }
                },
                T = function() {
                    var t = e(this),
                        ...
                        u = [r.height() / s.outerHeight(!1), r.width() / s.outerWidth(!1)],
                        a = [parseInt(o[0].css("min-height")), Math.round(u[0] * o[0].parent().height()), parseInt(o[1].css("min-width")), Math.round(u[1] * o[1].parent().width())],
                        f = l && a[1] < a[0] ? a[0] : a[1],
                        c = l && a[3] < a[2] ? a[2] : a[3];
                    o[0].css({
                        height: f,
                ...
                N = function() {
                    var t = e(this),
                        ...
                        s = e("#mCSB_" + n.idx + "_container"),
                        o = [e("#mCSB_" + n.idx + "_dragger_vertical"), e("#mCSB_" + n.idx + "_dragger_horizontal")],
                        u = [s.outerHeight(!1) - r.height(), s.outerWidth(!1) - r.width()],
                        a = [u[0] / (o[0].parent().height() - o[0].height()), u[1] / (o[1].parent().width() - o[1].width())];
                    n.scrollRatio = {
                        y: a[0],
                        x: a[1]
                    }
                ...
                C = function(e, t, n) {
                    var r = n ? h[0] + "_expanded" : "",
                        i = e.closest(".mCSB_scrollTools");
                    "active" === t ? (e.toggleClass(h[0] + " " + r), i.toggleClass(h[1]), e[0]._draggable = e[0]._draggable ? 0 : 1) : e[0]._draggable || ("hide" === t ? (e.removeClass(h[0]), i.removeClass(h[1])) : (e.addClass(h[0]), i.addClass(h[1])))
                },
                k = function() {
                    var t = e(this),
                        n = t.data(i),
                        r = e("#mCSB_" + n.idx),
                        s = e("#mCSB_" + n.idx + "_container"),
                        o = null == n.overflowed ? s.height() : s.outerHeight(!1),
                        u = null == n.overflowed ? s.width() : s.outerWidth(!1);
                ...
                L = function() {
                    var t = e(this),
                        ...
                        u = [e("#mCSB_" + n.idx + "_dragger_vertical"), e("#mCSB_" + n.idx + "_dragger_horizontal")];
                    if (J(t), ("x" !== r.axis && !n.overflowed[0] || "y" === r.axis && n.overflowed[0]) && (u[0].add(o).css("top", 0), K(t, "_resetY")), "y" !== r.axis && !n.overflowed[1] || "x" === r.axis && n.overflowed[1]) {
                        var a = dx = 0;
                        "rtl" === n.langDir && (a = s.width() - o.outerWidth(!1), dx = Math.abs(a / n.scrollRatio.x)), o.css("left", a), u[1].css("left", dx), K(t, "_resetX")
                    }
                },
                A = function() {
                    function t() {
                        o = setTimeout(function() {
                            e.event.special.mousewheel ? (clearTimeout(o), B.call(n[0])) : t()
                        }, 100)
                    }
                    var n = e(this),
                        r = n.data(i),
                        s = r.opt;
                    if (!r.bindEvents) {
                        if (D.call(this), s.contentTouchScroll && P.call(this), H.call(this), s.mouseWheel.enable) {
                            var o;
                            t()
                        }
                        F.call(this), q.call(this), s.advanced.autoScrollOnFocus && I.call(this), s.scrollButtons.enable && R.call(this), s.keyboard.enable && U.call(this), r.bindEvents = !0
                    }
                },
                O = function() {
                    var t = e(this),
                        ...
                        s = r.opt,
                        o = i + "_" + r.idx,
                        u = ".mCSB_" + r.idx + "_scrollbar",
                        f = e("#mCSB_" + r.idx + ",#mCSB_" + r.idx + "_container,#mCSB_" + r.idx + "_container_wrapper," + u + " ." + h[12] + ",#mCSB_" + r.idx + "_dragger_vertical,#mCSB_" + r.idx + "_dragger_horizontal," + u + ">a"),
                        l = e("#mCSB_" + r.idx + "_container");
                    s.advanced.releaseDraggableSelectors && f.add(e(s.advanced.releaseDraggableSelectors)), r.bindEvents && (e(n).unbind("." + o), f.each(function() {
                        e(this).unbind("." + o)
                    }), clearTimeout(t[0]._focusTimeout), Z(t[0], "_focusTimeout"), clearTimeout(r.sequential.step), Z(r.sequential, "step"), clearTimeout(l[0].onCompleteTimeout), Z(l[0], "onCompleteTimeout"), r.bindEvents = !1)
                },
                M = function(t) {
                    var n = e(this),
                        r = n.data(i),
                        s = r.opt,
                        o = e("#mCSB_" + r.idx + "_container_wrapper"),
                        u = o.length ? o : e("#mCSB_" + r.idx + "_container"),
                        a = [e("#mCSB_" + r.idx + "_scrollbar_vertical"), e("#mCSB_" + r.idx + "_scrollbar_horizontal")],
                        f = [a[0].find(".mCSB_dragger"), a[1].find(".mCSB_dragger")];
                    "x" !== s.axis && (r.overflowed[0] && !t ? (a[0].add(f[0]).add(a[0].children("a")).css("display", "block"), u.removeClass(h[8] + " " + h[10])) : (s.alwaysShowScrollbar ? (2 !== s.alwaysShowScrollbar && f[0].add(a[0].children("a")).css("display", "none"), u.removeClass(h[10])) : (a[0].css("display", "none"), u.addClass(h[10])), u.addClass(h[8]))), "y" !== s.axis && (r.overflowed[1] && !t ? (a[1].add(f[1]).add(a[1].children("a")).css("display", "block"), u.removeClass(h[9] + " " + h[11])) : (s.alwaysShowScrollbar ? (2 !== s.alwaysShowScrollbar && f[1].add(a[1].children("a")).css("display", "none"), u.removeClass(h[11])) : (a[1].css("display", "none"), u.addClass(h[11])), u.addClass(h[9]))), r.overflowed[0] || r.overflowed[1] ? n.removeClass(h[5]) : n.addClass(h[5])
                },
                _ = function(e) {
                    var t = e.type;
                    switch (t) {
                ...
                D = function() {
                    ...
                    function r(e, t, n, r) {
                        if (m[0].idleTimer = p.scrollInertia < 233 ? 250 : 0, s.attr("id") === v[1]) var i = "x",
                            o = (s[0].offsetLeft - t + r) * h.scrollRatio.x;
                        else var i = "y",
                            o = (s[0].offsetTop - e + n) * h.scrollRatio.y;
                        K(f, o.toString(), {
                            dir: i,
                            drag: !0
                        })
                    ...
                    var s, o, u, f = e(this),
                        ...
                        p = h.opt,
                        d = i + "_" + h.idx,
                        v = ["mCSB_" + h.idx + "_dragger_vertical", "mCSB_" + h.idx + "_dragger_horizontal"],
                        m = e("#mCSB_" + h.idx + "_container"),
                        g = e("#" + v[0] + ",#" + v[1]),
                        y = p.advanced.releaseDraggableSelectors ? g.add(e(p.advanced.releaseDraggableSelectors)) : g;
                    g.bind("mousedown." + d + " touchstart." + d + " pointerdown." + d + " MSPointerDown." + d, function(r) {
                        if (r.stopImmediatePropagation(), r.preventDefault(), et(r)) {
                            c = !0, l && (n.onselectstart = function() {
                                return !1
                            }), t(!1), J(f), s = e(this);
                            var i = s.offset(),
                                h = _(r)[0] - i.top,
                                ...
                                v = s.height() + i.top,
                                m = s.width() + i.left;
                            v > h && h > 0 && m > d && d > 0 && (o = h, u = d), C(s, "active", p.autoExpandScrollbar)
                        }
                        ...
                        var t = s.offset(),
                            ...
                            i = _(e)[1] - t.left;
                        r(o, u, n, i)
                    }), e(n).bind("mousemove." + d + " pointermove." + d + " MSPointerMove." + d, function(e) {
                        if (s) {
                            var t = s.offset(),
                                n = _(e)[0] - t.top,
                                i = _(e)[1] - t.left;
                    ...
                    }).add(y).bind("mouseup." + d + " touchend." + d + " pointerup." + d + " MSPointerUp." + d, function() {
                        s && (C(s, "active", p.autoExpandScrollbar), s = null), c = !1, l && (n.onselectstart = null), t(!0)
                    })
                },
                P = function() {
                    function t(e, t) {
                    ...
                    var r, s, o, u, a, f, l, h, p, d, v, m = e(this),
                        g = m.data(i),
                        y = g.opt,
                        b = i + "_" + g.idx,
                        w = e("#mCSB_" + g.idx),
                        E = e("#mCSB_" + g.idx + "_container"),
                        S = [e("#mCSB_" + g.idx + "_dragger_vertical"), e("#mCSB_" + g.idx + "_dragger_horizontal")],
                        x = [],
                        T = [],
                        N = 0,
                        C = "yx" === y.axis ? "none" : "all",
                        k = [];
                    E.bind("touchstart." + b + " pointerdown." + b + " MSPointerDown." + b, function(e) {
                        if (tt(e) && !c && !_(e)[2]) {
                            var t = E.offset();
                            r = _(e)[0] - t.top, s = _(e)[1] - t.left, k = [_(e)[0], _(e)[1]]
                        }
                    }).bind("touchmove." + b + " pointermove." + b + " MSPointerMove." + b, function(e) {
                        if (tt(e) && !c && !_(e)[2]) {
                            e.stopImmediatePropagation(), f = G();
                            var t = w.offset(),
                                i = _(e)[0] - t.top,
                                o = _(e)[1] - t.left,
                                u = "mcsLinearOut";
                            if (x.push(i), T.push(o), k[2] = Math.abs(_(e)[0] - k[0]), k[3] = Math.abs(_(e)[1] - k[1]), g.overflowed[0]) var a = S[0].parent().height() - S[0].height(),
                                l = r - i > 0 && i - r > -(a * g.scrollRatio.y) && (2 * k[3] < k[2] || "yx" === y.axis);
                            if (g.overflowed[1]) var h = S[1].parent().width() - S[1].width(),
                                p = s - o > 0 && o - s > -(h * g.scrollRatio.x) && (2 * k[2] < k[3] || "yx" === y.axis);
                            (l || p) && e.preventDefault(), d = "yx" === y.axis ? [r - i, s - o] : "x" === y.axis ? [null, s - o] : [r - i, null], E[0].idleTimer = 250, g.overflowed[0] && n(d[0], N, u, "y", "all", !0), g.overflowed[1] && n(d[1], N, u, "x", C, !0)
                        }
                    }), w.bind("touchstart." + b + " pointerdown." + b + " MSPointerDown." + b, function(e) {
                        if (tt(e) && !c && !_(e)[2]) {
                            e.stopImmediatePropagation(), J(m), a = G();
                            var t = w.offset();
                            o = _(e)[0] - t.top, u = _(e)[1] - t.left, x = [], T = []
                        }
                    }).bind("touchend." + b + " pointerup." + b + " MSPointerUp." + b, function(e) {
                        if (tt(e) && !c && !_(e)[2]) {
                            e.stopImmediatePropagation(), l = G();
                            var r = w.offset(),
                                i = _(e)[0] - r.top,
                                s = _(e)[1] - r.left;
                            if (!(l - f > 30)) {
                                ...
                                var m = "mcsEaseOut",
                                    b = 2.5 > p,
                                    S = b ? [x[x.length - 2], T[T.length - 2]] : [0, 0];
                                h = b ? [i - S[0], s - S[1]] : [i - o, s - u];
                                var N = [Math.abs(h[0]), Math.abs(h[1])];
                                p = b ? [Math.abs(h[0] / 4), Math.abs(h[1] / 4)] : [p, p];
                                var k = [Math.abs(E[0].offsetTop) - h[0] * t(N[0] / p[0], p[0]), Math.abs(E[0].offsetLeft) - h[1] * t(N[1] / p[1], p[1])];
                                d = "yx" === y.axis ? [k[0], k[1]] : "x" === y.axis ? [null, k[1]] : [k[0], null], v = [4 * N[0] + y.scrollInertia, 4 * N[1] + y.scrollInertia];
                                var L = parseInt(y.contentTouchScroll) || 0;
                                d[0] = N[0] > L ? d[0] : 0, d[1] = N[1] > L ? d[1] : 0, g.overflowed[0] && n(d[0], v[0], m, "y", C, !1), g.overflowed[1] && n(d[1], v[1], m, "x", C, !1)
                            }
                        }
                    })
                },
                H = function() {
                    ...
                    function s(e, t, n) {
                        h.type = n && o ? "stepped" : "stepless", h.scrollAmount = 10, z(u, e, t, "mcsLinearOut", n ? 60 : null)
                    }
                    var o, u = e(this),
                        f = u.data(i),
                        l = f.opt,
                        h = f.sequential,
                        p = i + "_" + f.idx,
                        d = e("#mCSB_" + f.idx + "_container"),
                        v = d.parent();
                    d.bind("mousedown." + p, function() {
                        o || (o = 1, c = !0)
                    }).add(n).bind("mousemove." + p, function(e) {
                        if (o && r()) {
                            var t = d.offset(),
                                n = _(e)[0] - t.top + d[0].offsetTop,
                                i = _(e)[1] - t.left + d[0].offsetLeft;
                            n > 0 && n < v.height() && i > 0 && i < v.width() ? h.step && s("off", null, "stepped") : ("x" !== l.axis && f.overflowed[0] && (0 > n ? s("on", 38) : n > v.height() && s("on", 40)), "y" !== l.axis && f.overflowed[1] && (0 > i ? s("on", 37) : i > v.width() && s("on", 39)))
                        }
                    }).bind("mouseup." + p, function() {
                        o && (o = 0, s("off", null)), c = !1
                    })
                },
                B = function() {
                    function t(e) {
                    ...
                    if (r) {
                        var s = r.opt,
                            o = i + "_" + r.idx,
                            u = e("#mCSB_" + r.idx),
                            a = [e("#mCSB_" + r.idx + "_dragger_vertical"), e("#mCSB_" + r.idx + "_dragger_horizontal")],
                            f = e("#mCSB_" + r.idx + "_container").find("iframe"),
                            c = u;
                        f.length && f.each(function() {
                            var n = this;
                            t(n) && (c = c.add(e(n).contents().find("body")))
                        }), c.bind("mousewheel." + o, function(t, i) {
                            if (J(n), !j(n, t.target)) {
                                var o = "auto" !== s.mouseWheel.deltaFactor ? parseInt(s.mouseWheel.deltaFactor) : l && t.deltaFactor < 100 ? 100 : t.deltaFactor || 100;
                                if ("x" === s.axis || "x" === s.mouseWheel.axis) var f = "x",
                                    c = [Math.round(o * r.scrollRatio.x), parseInt(s.mouseWheel.scrollAmount)],
                                    h = "auto" !== s.mouseWheel.scrollAmount ? c[1] : c[0] >= u.width() ? .9 * u.width() : c[0],
                                    p = Math.abs(e("#mCSB_" + r.idx + "_container")[0].offsetLeft),
                                    d = a[1][0].offsetLeft,
                                    v = a[1].parent().width() - a[1].width(),
                                    m = t.deltaX || t.deltaY || i;
                                else var f = "y",
                                    c = [Math.round(o * r.scrollRatio.y), parseInt(s.mouseWheel.scrollAmount)],
                                    h = "auto" !== s.mouseWheel.scrollAmount ? c[1] : c[0] >= u.height() ? .9 * u.height() : c[0],
                                    p = Math.abs(e("#mCSB_" + r.idx + "_container")[0].offsetTop),
                                    d = a[0][0].offsetTop,
                                    v = a[0].parent().height() - a[0].height(),
                                    m = t.deltaY || i;
                                "y" === f && !r.overflowed[0] || "x" === f && !r.overflowed[1] || (s.mouseWheel.invert && (m = -m), s.mouseWheel.normalizeDelta && (m = 0 > m ? -1 : 1), (m > 0 && 0 !== d || 0 > m && d !== v || s.mouseWheel.preventDefault) && (t.stopImmediatePropagation(), t.preventDefault()), K(n, (p - m * h).toString(), {
                                    dir: f
                                }))
                            }
                        })
                ...
                j = function(t, n) {
                    var r = n.nodeName.toLowerCase(),
                        ...
                        o = ["select", "textarea"];
                    return e.inArray(r, s) > -1 && !(e.inArray(r, o) > -1 && !e(n).is(":focus"))
                },
                F = function() {
                    var t = e(this),
                        n = t.data(i),
                        ...
                        s = e("#mCSB_" + n.idx + "_container"),
                        o = s.parent(),
                        u = e(".mCSB_" + n.idx + "_scrollbar ." + h[12]);
                    u.bind("touchstart." + r + " pointerdown." + r + " MSPointerDown." + r, function() {
                        c = !0
                    }).bind("touchend." + r + " pointerup." + r + " MSPointerUp." + r, function() {
                        c = !1
                    }).bind("click." + r, function(r) {
                        if (e(r.target).hasClass(h[12]) || e(r.target).hasClass("mCSB_draggerRail")) {
                            J(t);
                            var i = e(this),
                            ...
                            if (i.parent(".mCSB_scrollTools_horizontal").length > 0) {
                                ...
                                var f = "x",
                                    ...
                                    c = Math.abs(s[0].offsetLeft) - .9 * l * o.width()
                            } else {
                                if (!n.overflowed[0]) return;
                                var f = "y",
                                    l = r.pageY > u.offset().top ? -1 : 1,
                                    c = Math.abs(s[0].offsetTop) - .9 * l * o.height()
                            }
                            K(t, c.toString(), {
                                dir: f,
                                scrollEasing: "mcsEaseInOut"
                ...
                I = function() {
                    var t = e(this),
                        ...
                        f = u.parent();
                    u.bind("focusin." + o, function() {
                        var r = e(n.activeElement),
                            i = u.find(".mCustomScrollBox").length,
                            o = 0;
                        r.is(s.advanced.autoScrollOnFocus) && (J(t), clearTimeout(t[0]._focusTimeout), t[0]._focusTimer = i ? (o + 17) * i : 0, t[0]._focusTimeout = setTimeout(function() {
                            var e = [rt(r)[0], rt(r)[1]],
                                n = [u[0].offsetTop, u[0].offsetLeft],
                                i = [n[0] + e[0] >= 0 && n[0] + e[0] < f.height() - r.outerHeight(!1), n[1] + e[1] >= 0 && n[0] + e[1] < f.width() - r.outerWidth(!1)],
                                a = "yx" !== s.axis || i[0] || i[1] ? "all" : "none";
                            "x" === s.axis || i[0] || K(t, e[0].toString(), {
                                dir: "y",
                                scrollEasing: "mcsEaseInOut",
                                overwrite: a,
                                dur: o
                            }), "y" === s.axis || i[1] || K(t, e[1].toString(), {
                                dir: "x",
                                scrollEasing: "mcsEaseInOut",
                                overwrite: a,
                                dur: o
                ...
                q = function() {
                    var t = e(this),
                        n = t.data(i),
                        r = i + "_" + n.idx,
                        s = e("#mCSB_" + n.idx + "_container").parent();
                    s.bind("scroll." + r, function() {
                        (0 !== s.scrollTop() || 0 !== s.scrollLeft()) && e(".mCSB_" + n.idx + "_scrollbar").css("visibility", "hidden")
                    })
                },
                R = function() {
                    var t = e(this),
                        ...
                        s = n.sequential,
                        o = i + "_" + n.idx,
                        u = ".mCSB_" + n.idx + "_scrollbar",
                        a = e(u + ">a");
                    a.bind("mousedown." + o + " touchstart." + o + " pointerdown." + o + " MSPointerDown." + o + " mouseup." + o + " touchend." + o + " pointerup." + o + " MSPointerUp." + o + " mouseout." + o + " pointerout." + o + " MSPointerOut." + o + " click." + o, function(i) {
                        function o(e, n) {
                            s.scrollAmount = r.snapAmount || r.scrollButtons.scrollAmount, z(t, e, n)
                        }
                        if (i.preventDefault(), et(i)) {
                            var u = e(this).attr("class");
                            switch (s.type = r.scrollButtons.scrollType, i.type) {
                                case "mousedown":
                                case "touchstart":
                                case "pointerdown":
                                case "MSPointerDown":
                                    if ("stepped" === s.type) return;
                                    c = !0, n.tweenRunning = !1, o("on", u);
                                    break;
                                case "mouseup":
                                case "touchend":
                                case "pointerup":
                ...
                U = function() {
                    ...
                    f.attr("tabindex", "0").bind("blur." + u + " keydown." + u + " keyup." + u, function(i) {
                        function u(e, n) {
                            o.type = s.keyboard.scrollType, o.scrollAmount = s.snapAmount || s.keyboard.scrollAmount, "stepped" === o.type && r.tweenRunning || z(t, e, n)
                        }
                        switch (i.type) {
                            case "blur":
                                r.tweenRunning && o.dir && u("off", null);
                                break;
                            case "keydown":
                            case "keyup":
                                var f = i.keyCode ? i.keyCode : i.which,
                                    p = "on";
                                if ("x" !== s.axis && (38 === f || 40 === f) || "y" !== s.axis && (37 === f || 39 === f)) {
                                    if ((38 === f || 40 === f) && !r.overflowed[0] || (37 === f || 39 === f) && !r.overflowed[1]) return;
                                    "keyup" === i.type && (p = "off"), e(n.activeElement).is(h) || (i.preventDefault(), i.stopImmediatePropagation(), u(p, f))
                                } else if (33 === f || 34 === f) {
                                    if ((r.overflowed[0] || r.overflowed[1]) && (i.preventDefault(), i.stopImmediatePropagation()), "keyup" === i.type) {
                                        J(t);
                                        var d = 34 === f ? -1 : 1;
                                        if ("x" === s.axis || "yx" === s.axis && r.overflowed[1] && !r.overflowed[0]) var v = "x",
                                            m = Math.abs(l[0].offsetLeft) - .9 * d * c.width();
                                        else var v = "y",
                                            m = Math.abs(l[0].offsetTop) - .9 * d * c.height();
                                        K(t, m.toString(), {
                                            dir: v,
                                            scrollEasing: "mcsEaseInOut"
                                        })
                                    }
                                } else if ((35 === f || 36 === f) && !e(n.activeElement).is(h) && ((r.overflowed[0] || r.overflowed[1]) && (i.preventDefault(), i.stopImmediatePropagation()), "keyup" === i.type)) {
                                    if ("x" === s.axis || "yx" === s.axis && r.overflowed[1] && !r.overflowed[0]) var v = "x",
                                        m = 35 === f ? Math.abs(c.width() - l.outerWidth(!1)) : 0;
                                    else var v = "y",
                                        m = 35 === f ? Math.abs(c.height() - l.outerHeight(!1)) : 0;
                                    K(t, m.toString(), {
                                        dir: v,
                                        scrollEasing: "mcsEaseInOut"
                                    })
                ...
                z = function(t, n, r, s, o) {
                    function u(e) {
                        var n = "stepped" !== c.type,
                            r = o ? o : e ? n ? l.scrollInertia / 1.5 : l.scrollInertia : 1e3 / 60,
                            i = e ? n ? 7.5 : 40 : 2.5,
                            a = [Math.abs(p[0].offsetTop), Math.abs(p[0].offsetLeft)],
                            h = [f.scrollRatio.y > 10 ? 10 : f.scrollRatio.y, f.scrollRatio.x > 10 ? 10 : f.scrollRatio.x],
                            d = "x" === c.dir[0] ? a[1] + c.dir[1] * h[1] * i : a[0] + c.dir[1] * h[0] * i,
                            v = "x" === c.dir[0] ? a[1] + c.dir[1] * parseInt(c.scrollAmount) : a[0] + c.dir[1] * parseInt(c.scrollAmount),
                            m = "auto" !== c.scrollAmount ? v : d,
                            g = s ? s : e ? n ? "mcsLinearOut" : "mcsEaseInOut" : "mcsLinear",
                            y = e ? !0 : !1;
                        return e && 17 > r && (m = "x" === c.dir[0] ? a[1] : a[0]), K(t, m.toString(), {
                            dir: c.dir[0],
                            scrollEasing: g,
                            dur: r,
                            onComplete: y
                    ...
                    function a() {
                        clearTimeout(c.step), Z(c, "step"), J(t)
                    }
                    var f = t.data(i),
                        l = f.opt,
                        c = f.sequential,
                        p = e("#mCSB_" + f.idx + "_container"),
                        d = "stepped" === c.type ? !0 : !1;
                    switch (n) {
                        case "on":
                            if (c.dir = [r === h[16] || r === h[15] || 39 === r || 37 === r ? "x" : "y", r === h[13] || r === h[15] || 38 === r || 37 === r ? -1 : 1], J(t), nt(r) && "stepped" === c.type) return;
                            u(d);
                            break;
                        case "off":
                            a(), (d || f.tweenRunning && c.dir) && u(!0)
                    }
                },
                W = function(t) {
                ...
                X = function(t, n) {
                    if (null != t && "undefined" != typeof t) {
                        var r = e(this),
                            ...
                            f = typeof t;
                        n || (n = "x" === o.axis ? "x" : "y");
                        var l = "x" === n ? u.outerWidth(!1) : u.outerHeight(!1),
                            c = "x" === n ? u[0].offsetLeft : u[0].offsetTop,
                            h = "x" === n ? "left" : "top";
                        switch (f) {
                            case "function":
                                return t();
                            case "object":
                                var d = t.jquery ? t : e(t);
                                if (!d.length) return;
                                return "x" === n ? rt(d)[1] : rt(d)[0];
                            case "string":
                            case "number":
                                ...
                                if (-1 !== t.indexOf("+=")) {
                                    var v = c + parseInt(t.split("+=")[1]);
                                    return v >= 0 ? 0 : Math.abs(v)
                                }
                                if (-1 !== t.indexOf("px") && nt(t.split("px")[0])) return Math.abs(t.split("px")[0]);
                                if ("top" === t || "left" === t) return 0;
                                if ("bottom" === t) return Math.abs(a.height() - u.outerHeight(!1));
                                if ("right" === t) return Math.abs(a.width() - u.outerWidth(!1));
                                if ("first" === t || "last" === t) {
                                    var d = u.find(":" + t);
                                    return "x" === n ? rt(d)[1] : rt(d)[0]
                                }
                                return e(t).length ? "x" === n ? rt(e(t))[1] : rt(e(t))[0] : (u.css(h, t), void p.update.call(null, r[0]))
                        }
                    }
                },
                V = function(t) {
                    function n() {
                        clearTimeout(c[0].autoUpdate), c[0].autoUpdate = setTimeout(function() {
                            return l.advanced.updateOnSelectorChange && (d = o(), d !== w) ? (u(3), void(w = d)) : (l.advanced.updateOnContentResize && (v = [c.outerHeight(!1), c.outerWidth(!1), g.height(), g.width(), b()[0], b()[1]], (v[0] !== E[0] || v[1] !== E[1] || v[2] !== E[2] || v[3] !== E[3] || v[4] !== E[4] || v[5] !== E[5]) && (u(v[0] !== E[0] || v[1] !== E[1]), E = v)), l.advanced.updateOnImageLoad && (m = r(), m !== S && (c.find("img").each(function() {
                                s(this)
                            }), S = m)), void((l.advanced.updateOnSelectorChange || l.advanced.updateOnContentResize || l.advanced.updateOnImageLoad) && n()))
                        }, 60)
                    }

                    function r() {
                        var e = 0;
                        return l.advanced.updateOnImageLoad && (e = c.find("img").length), e
                    }
                    ...
                    function s(t) {
                        ...
                        function r() {
                            this.onload = null, e(t).addClass(h[2]), u(2)
                        }
                        if (e(t).hasClass(h[2])) return void u();
                        var i = new Image;
                        i.onload = n(i, r), i.src = t.src
                    }

                    function o() {
                        l.advanced.updateOnSelectorChange === !0 && (l.advanced.updateOnSelectorChange = "*");
                        var t = 0,
                            n = c.find(l.advanced.updateOnSelectorChange);
                        return l.advanced.updateOnSelectorChange && n.length > 0 && n.each(function() {
                            t += e(this).height() + e(this).width()
                        }), t
                    }

                    function u(e) {
                        clearTimeout(c[0].autoUpdate), p.update.call(null, a[0], e)
                    }
                    var a = e(this),
                        f = a.data(i),
                        l = f.opt,
                        c = e("#mCSB_" + f.idx + "_container");
                    if (t) return clearTimeout(c[0].autoUpdate), void Z(c[0], "autoUpdate");
                    var d, v, m, g = c.parent(),
                        y = [e("#mCSB_" + f.idx + "_scrollbar_vertical"), e("#mCSB_" + f.idx + "_scrollbar_horizontal")],
                        b = function() {
                            return [y[0].is(":visible") ? y[0].outerHeight(!0) : 0, y[1].is(":visible") ? y[1].outerWidth(!0) : 0]
                        },
                        w = o(),
                        E = [c.outerHeight(!1), c.outerWidth(!1), g.height(), g.width(), b()[0], b()[1]],
                        S = r();
                    n()
                },
                $ = function(e, t, n) {
                ...
                K = function(t, n, r) {
                    function s(e) {
                        return a && f.callbacks[e] && "function" == typeof f.callbacks[e]
                    }

                    function o() {
                        return [f.callbacks.alwaysTriggerOffsets || b >= w[0] + S, f.callbacks.alwaysTriggerOffsets || -x >= b]
                    }
                    ...
                    function u() {
                        ...
                        t[0].mcs = {
                            ...
                            draggerTop: n[0],
                            draggerLeft: n[1],
                            topPct: Math.round(100 * Math.abs(e[0]) / (Math.abs(i[0]) - s[0])),
                            leftPct: Math.round(100 * Math.abs(e[1]) / (Math.abs(i[1]) - s[1])),
                            direction: r.dir
                        }
                    }
                    var a = t.data(i),
                        ...
                        d = p.parent(),
                        v = f.callbacks.onTotalScrollOffset ? W.call(t, f.callbacks.onTotalScrollOffset) : [0, 0],
                        m = f.callbacks.onTotalScrollBackOffset ? W.call(t, f.callbacks.onTotalScrollBackOffset) : [0, 0];
                    if (a.trigger = r.trigger, (0 !== d.scrollTop() || 0 !== d.scrollLeft()) && (e(".mCSB_" + a.idx + "_scrollbar").css("visibility", "visible"), d.scrollTop(0).scrollLeft(0)), "_resetY" !== n || a.contentReset.y || (s("onOverflowYNone") && f.callbacks.onOverflowYNone.call(t[0]), a.contentReset.y = 1), "_resetX" !== n || a.contentReset.x || (s("onOverflowXNone") && f.callbacks.onOverflowXNone.call(t[0]), a.contentReset.x = 1), "_resetY" !== n && "_resetX" !== n) {
                        switch (!a.contentReset.y && t[0].mcs || !a.overflowed[0] || (s("onOverflowY") && f.callbacks.onOverflowY.call(t[0]), a.contentReset.x = null), !a.contentReset.x && t[0].mcs || !a.overflowed[1] || (s("onOverflowX") && f.callbacks.onOverflowX.call(t[0]), a.contentReset.x = null), f.snapAmount && (n = $(n, f.snapAmount, f.snapOffset)), r.dir) {
                            case "x":
                                var g = e("#mCSB_" + a.idx + "_dragger_horizontal"),
                                    y = "left",
                                    b = p[0].offsetLeft,
                                    w = [h.width() - p.outerWidth(!1), g.parent().width() - g.width()],
                                    E = [n, 0 === n ? 0 : n / a.scrollRatio.x],
                                    S = v[1],
                                    x = m[1],
                                    T = S > 0 ? S / a.scrollRatio.x : 0,
                                    N = x > 0 ? x / a.scrollRatio.x : 0;
                                break;
                            case "y":
                                var g = e("#mCSB_" + a.idx + "_dragger_vertical"),
                                    y = "top",
                                    b = p[0].offsetTop,
                                    w = [h.height() - p.outerHeight(!1), g.parent().height() - g.height()],
                                    E = [n, 0 === n ? 0 : n / a.scrollRatio.y],
                                    S = v[0],
                                    x = m[0],
                                    T = S > 0 ? S / a.scrollRatio.y : 0,
                                    N = x > 0 ? x / a.scrollRatio.y : 0
                        }
                        E[1] < 0 || 0 === E[0] && 0 === E[1] ? E = [0, 0] : E[1] >= w[1] ? E = [w[0], w[1]] : E[0] = -E[0], t[0].mcs || (u(), s("onInit") && f.callbacks.onInit.call(t[0])), clearTimeout(p[0].onCompleteTimeout), (a.tweenRunning || !(0 === b && E[0] >= 0 || b === w[0] && E[0] <= w[0])) && (Q(g[0], y, Math.round(E[1]), c[1], r.scrollEasing), Q(p[0], y, Math.round(E[0]), c[0], r.scrollEasing, r.overwrite, {
                            onStart: function() {
                                r.callbacks && r.onStart && !a.tweenRunning && (s("onScrollStart") && (u(), f.callbacks.onScrollStart.call(t[0])), a.tweenRunning = !0, C(g), a.cbOffsets = o())
                            },
                            onUpdate: function() {
                                r.callbacks && r.onUpdate && s("whileScrolling") && (u(), f.callbacks.whileScrolling.call(t[0]))
                            },
                            onComplete: function() {
                                if (r.callbacks && r.onComplete) {
                                    "yx" === f.axis && clearTimeout(p[0].onCompleteTimeout);
                                    var e = p[0].idleTimer || 0;
                                    p[0].onCompleteTimeout = setTimeout(function() {
                                        s("onScroll") && (u(), f.callbacks.onScroll.call(t[0])), s("onTotalScroll") && E[1] >= w[1] - T && a.cbOffsets[0] && (u(), f.callbacks.onTotalScroll.call(t[0])), s("onTotalScrollBack") && E[1] <= N && a.cbOffsets[1] && (u(), f.callbacks.onTotalScrollBack.call(t[0])), a.tweenRunning = !1, p[0].idleTimer = 0, C(g, "hide")
                                    }, e)
                                }
                            }
                        }))
                ...
                Q = function(e, n, r, i, s, o, u) {
                    function a() {
                        S.stop || (b || v.call(), b = G() - y, f(), b >= S.time && (S.time = b > S.time ? b + p - (b - S.time) : b + p - 1, S.time < b + 1 && (S.time = b + 1)), S.time < i ? S.id = d(a) : g.call())
                    }

                    function f() {
                        i > 0 ? (S.currVal = h(S.time, w, x, i, s), E[n] = Math.round(S.currVal) + "px") : E[n] = r + "px", m.call()
                    }

                    function l() {
                        p = 1e3 / 60, S.time = b + p, d = t.requestAnimationFrame ? t.requestAnimationFrame : function(e) {
                            return f(), setTimeout(e, .01)
                        }, S.id = d(a)
                    }
                    ...
                    var p, d, u = u || {},
                        v = u.onStart || function() {},
                        m = u.onUpdate || function() {},
                        g = u.onComplete || function() {},
                        y = G(),
                        b = 0,
                        w = e.offsetTop,
                        E = e.style,
                        S = e._mTween[n];
                    "left" === n && (w = e.offsetLeft);
                    var x = r - w;
                    S.stop = 0, "none" !== o && c(), l()
                },
                G = function() {
                ...
                Y = function() {
                    ...
                    for (var n = ["top", "left"], r = 0; r < n.length; r++) {
                        var i = n[r];
                        e._mTween[i].id && (t.requestAnimationFrame ? t.cancelAnimationFrame(e._mTween[i].id) : clearTimeout(e._mTween[i].id), e._mTween[i].id = null, e._mTween[i].stop = 1)
                    }
                },
                Z = function(e, t) {
                    try {
            ...
            e.fn[r] = function(t) {
                ...
                return p[t] ? p[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error("Method " + t + " does not exist") : p.init.apply(this, arguments)
            }, e[r].defaults = o, t[r] = !0, e(t).load(function() {
                e(s)[r](), e.extend(e.expr[":"], {
                    mcsInView: e.expr[":"].mcsInView || function(t) {
                        var n, r, i = e(t),
                            s = i.parents(".mCSB_container");
                        if (s.length) return n = s.parent(), r = [s[0].offsetTop, s[0].offsetLeft], r[0] + rt(i)[0] >= 0 && r[0] + rt(i)[0] < n.height() - i.outerHeight(!1) && r[1] + rt(i)[1] >= 0 && r[1] + rt(i)[1] < n.width() - i.outerWidth(!1)
                    },
    ...
    }(jQuery, window, document), define("modules/offers", ["jquery", "underscore", "waitforimages", "customScroll", "velocity"], function(e, t) {
        var n = {
                trigger: e(".js-show-details"),
                desc: e(".js-description"),
                close: e(".js-close-details"),
                book: e(".js-booknow-btn")
            },
            r = {
                init: function() {
                    r.offerDetails.prepareData(), n.trigger.click(function() {
                        var t = e(this).closest(".js-offer-block");
                        r.offerDetails.collectData(t)
                    }), n.close.click(function() {
                        e(".js-book-container.is-open").length ? r.offerDetails.closeForm() : r.offerDetails.close()
                    }), n.book.click(function() {
                        r.offerDetails.showForm()
                    })
                },
                offerDetails: {
                    prepareData: function() {
                        n.desc.each(function() {
                            e(this).data("description", e(this).html().trim())
                        }), n.desc.each(function() {
                            var t = e(this).data("description").substring(0, 270);
                            e(this).html(t).append("...")
                        })
                    },
                    collectData: function(t) {
                        var n = e(".js-name", t).html(),
                            i = e(".js-description", t).data("description"),
                            s = e(".js-cost", t).html(),
                            o = e("img", t).data("large-images"),
                            u = e(".day", t),
                            a = e("img", t).data("path");
                        t.hasClass("loaded") ? window.newOffer = !1 : (window.newOffer = !0, t.addClass("loaded")), r.offerDetails.fillData(n, i, s, o, u, a)
                    },
                    fillData: function(t, n, i, s, o, u) {
                        var a = e(".js-details-wrapper"),
                            f = [],
                            l = "<div class='wrapper fullheight owl slider offers-slider ovh' data-config=''></div>";
                        e.each(s, function(t, n) {
                            var r = e("<img src=" + u + n + ' alt="" class="image fullwidth">');
                            f.push(r)
                        }), e(".offers-slider-container").html(e(l)), e.each(f, function(t, n) {
                            e(".offers-slider").append(n)
                        }), e(".offers-slider", a).owlCarousel({
                            items: 1,
                            dots: !1,
                            nav: !0,
                            navText: ["", ""]
                        }), e(".order-name-field", a).val(t), e(".order-price-field", a).val(i), e(".js-item-title", a).html(t), e(".item-description", a).html(n), e(".js-item-price", a).html(i), e(".js-days-list", a).html(""), o.each(function() {
                            var t = e(".js-title", e(this)).html(),
                                n = e(".js-acc-description", e(this)).html(),
                                r = ['<div class="wrapper js-day-item day-item mb10">', '<div class="wrapper ac day-title pointer">', '<h5 class="title text fz6 c lh22 fw3 js-day-title">' + t + "</h5>", "</div>", '<div class="wrapper day-description">', '<p class="js-day-description text fw3 fsi c6 fz1 lh2 pl20 pt15 pr20 pb15">' + n + "</p>", "</div>", "</div>"].join("");
                            e(".js-days-list", a).append(e(r))
                        }), r.initOffersAccordion(), r.offerDetails.open()
                    },
                    open: function() {
                        window.newOffer && e(".offers-slider-container").removeClass("offer-loaded").append('<div class="loading-offer-images">loading images</div>').waitForImages(function() {
                            e(this).addClass("offer-loaded"), setTimeout(function() {
                                e(".loading-offer-images").remove()
                            }, 300)
                        }), e(".js-details-wrapper").addClass("is-open").velocity({
                            translateX: ["0", "100%"]
                        }, 500, "ease", function() {
                            e("body").css("overflow", "hidden"), e(".js-details-wrapper").css("overflow-y", "scroll")
                        })
                    },
                    close: function() {
                        e("body").css({
                            "overflow-y": "scroll",
                            "overflow-x": "hidden"
                        }), e(".js-details-wrapper").css("overflow", "hidden").removeClass("is-open"), e(".js-details-wrapper").velocity({
                            translateX: ["100%", "0"]
                        }, 500, "ease", function() {
                            r.offerDetails.reset(), r.offerDetails.closeForm()
                        })
                    },
                    reset: function() {
                        var t = e(".js-details-wrapper");
                        e(".js-days-list", t).html(""), e(".js-item-price", t).html(""), e(".item-description", t).html(""), e(".js-item-title", t).html(""), e(".offers-slider-container", t).html("")
                    },
                    showForm: function() {
                        e(".js-book-container").velocity({
                            translateX: ["0", "100%"]
                        }, 500, "ease").addClass("is-open"), e(".offer-tabs-container").addClass("is-open")
                    },
                    closeForm: function() {
                        e(".js-book-container").velocity({
                            translateX: "100%"
                        }, 500, "ease").removeClass("is-open"), e(".offer-tabs-container").removeClass("is-open"), e(".error").removeClass("error")
                    }
                },
                initOffersAccordion: function() {
                    e(".day-description").hide().click(function(e) {
                        e.stopPropagation()
                    }), e(".js-day-item").click(function() {
                        var t = e(this);
                        e(".changing-offer-tab").length || (t.addClass("changing-offer-tab"), e(".js-day-item.active").length ? t.hasClass("active") ? e(".day-description", t).slideUp(300, function() {
                            t.removeClass("active"), e(".changing-offer-tab").removeClass("changing-offer-tab")
                        }) : e(".js-day-item.active .day-description").slideUp(300, function() {
                            e(".js-day-item").removeClass("active"), e(".day-description", t).slideDown(300, function() {
                                e(".changing-offer-tab").removeClass("changing-offer-tab"), t.addClass("active")
                            })
                        }) : (t.addClass("active"), e(".day-description", t).slideDown(300, function() {
                            e(".changing-offer-tab").removeClass("changing-offer-tab")
                        })))
                    })
                }
            };
        r.init()
    }), define("modules/menu", ["jquery", "velocity", "velocityUi"], function(e) {
        var t = {
                navsList: e(".menu ul")
            },
            n = {
                init: function() {
                    this.cloneNavs(), this.bindToggleBtn()
                },
                bindToggleBtn: function() {
                    var t = e(".js-mobile-menu");
                    e(".js-menu-toggle").click(function(e) {
                        e.stopPropagation(), t.show().velocity({
                            translateY: ["0", "-100%"]
                        }, 500, "ease").addClass("is-active")
                    }), e("body").click(function() {
                        t.hasClass("is-active") && t.velocity("reverse", function() {
                            t.hide().removeClass("is-active")
                        })
                    })
                },
                cloneNavs: function() {
                    var n = e('<div class="mobile-menu menu js-mobile-menu">');
                    t.navsList.clone().appendTo(n), n.prependTo("body"), this.bindNavsAction()
                },
                bindNavsAction: function() {
                    var t = e(".menu a, .js-all-tours");
                    t.each(function() {
    ...
    function(e) {
        e.fn.animateNumbers = function(t, n, r, i) {
            return this.each(function() {
                var s = e(this),
                    o = parseInt(s.text().replace(/,/g, ""));
                n = n === undefined ? !0 : n, e({
                    value: o
                }).animate({
                    value: t
                }, {
                    duration: r == undefined ? 1e3 : r,
                    easing: i == undefined ? "swing" : i,
                    step: function() {
                        s.text(Math.floor(this.value)), n && s.text(s.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"))
                    },
                    complete: function() {
                        parseInt(s.text()) !== t && (s.text(t), n && s.text(s.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")))
                    }
                })
            })
        }
    }(jQuery), define("odometer", function() {}), ! function(e) {
        function t() {
            var t, n, r = {
                height: f.innerHeight,
                width: f.innerWidth
            };
            return r.height || (t = a.compatMode, (t || !e.support.boxModel) && (n = "CSS1Compat" === t ? l : a.body, r = {
        ...
        function n() {
            return {
                top: f.pageYOffset || l.scrollTop || a.body.scrollTop,
                left: f.pageXOffset || l.scrollLeft || a.body.scrollLeft
            }
        }
        ...
        function r() {
            ...
            if (e.each(u, function(e, t) {
                    var n = t.data.selector,
                        r = t.$element;
                    o = o.add(n ? r.find(n) : r)
                }), r = o.length)
                for (i = i || t(), s = s || n(); r > a; a++)
                    if (e.contains(l, o[a])) {
                        var f, c, p, v = e(o[a]),
                            m = {
                                height: v.height(),
                            ...
                            y = v.data("inview");
                        if (!s || !i) return;
                        g.top + m.height > s.top && g.top < s.top + i.height && g.left + m.width > s.left && g.left < s.left + i.width ? (f = s.left > g.left ? "right" : s.left + i.width < g.left + m.width ? "left" : "both", c = s.top > g.top ? "bottom" : s.top + i.height < g.top + m.height ? "top" : "both", p = f + "-" + c, y && y === p || v.data("inview", p).trigger("inview", [!0, f, c])) : y && v.data("inview", !1).trigger("inview", [!1])
                    }
        }
        var i, s, o, u = {},
            a = document,
        ...
        e.event.special.inview = {
            add: function(t) {
                u[t.guid + "-" + this[c]] = {
                    data: t,
                    $element: e(this)
                }, o || e.isEmptyObject(u) || (o = setInterval(r, 250))
            },
            remove: function(t) {
                try {
                    delete u[t.guid + "-" + this[c]]
                } catch (n) {}
                e.isEmptyObject(u) && (clearInterval(o), o = null)
            }
    ...
    }(jQuery), define("inview", function() {}), define("modules/numbers", ["jquery", "odometer", "inview"], function() {
        var e = {
            init: function() {
                this.bindUiActions()
            },
            bindUiActions: function() {
                $(".odometer").each(function() {
                    var e = $(this).html();
                    $(this).html("0"), $(this).one("inview", function() {
                        $(this).animateNumbers(e, !1, 2e3)
                    })
                })
            }
        };
        e.init()
    }), define("modules/validate", ["jquery", "velocity"], function() {
        var e = {
            init: function() {
                this.bindUiActions()
            },
            ...
            start: function(t) {
                var n = !0,
                    r = t.closest("form");
                $(".required", r).each(function() {
                    $(this).val($(this).val().trim());
                    var e = $(this).val().replace(/\s+/g, ""),
                        t = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
                    if ($(this).attr("name") === "mail_field") {
                        if (e === "" || !t.test(e)) n = !1, $(this).parent().addClass("error")
                    } else e === "" && (n = !1, $(this).parent().addClass("error"))
                }), n ? (e.sendForm(r), e.activeState(r, "succes")) : e.activeState(r, "error")
            },
            activeState: function(e, t) {
                e.addClass("active-state"), setTimeout(function() {
    ...
    }), define("modules/reveal", ["jquery", "inview", "velocity", "velocityUi"], function() {
        var e = {
            ...
            t = {
                init: function() {
                    $(window).width() < 1025 ? $("html").addClass("low-device") : ($.each(e, function() {
                        this.css("opacity", "0")
                    }), t.bindUiActions()), this.reveal.skills()
                },
                bindUiActions: function() {
                    this.reveal.offer(this), this.reveal.booknow(this), this.reveal.blog(this), this.reveal.quote(this), this.reveal.team(this), this.reveal.box(this), this.reveal.clients(this), this.reveal.testim(this), this.reveal.price(this), this.reveal.add(this)
                },
                toLeft: function(e, t) {
                    e.velocity({
                        translateX: ["0", "30px"],
                ...
                reveal: {
                    ...
                    offer: function(t) {
                        var n = e.$offer.closest("section");
                        n.each(function() {
                            $(this).find(e.$offer).each(function(e) {
                    ...
                    team: function(t) {
                        e.$team.each(function(e) {
                            $(".text", $(this)).css("opacity", "0"), $(this).one("inview", function() {
                                var e = 500;
                                $(this).velocity({
                                    translateY: ["0", "30px"],
                                    opacity: 1,
    ...
    function(e) {
    ...
    }(this), define("placeholder", function() {}), define("modules/preloader", ["jquery", "domReady", "modules/reveal", "browser", "velocity", "inview", "placeholder"], function(e, t, n, r) {
        var i = {
            init: function() {
                this.bindUiActions()
            },
            bindUiActions: function() {
                (r.msie || r.firefox) && e("html").addClass("no-parallax"), r.msie && e("*").css("background-attachment", "scroll"), t(function() {
                    n.init(), i.hidePreloader()
                })
            },
            hidePreloader: function() {
                e(".preloader-block").velocity({
                    translateY: ["-100%", "0"],
                    translateZ: "0"
                }, 1e3, "ease", function() {
                    e(window).trigger("pageLoaded")
                }), e("video.cover-el").length && (e("video.cover-el").trigger("play"), e(".volume-toggle").click(function() {
                    e(this).toggleClass("pe-7s-volume2 pe-7s-volume1");
                    var t = e("video.cover-el");
                    t.prop("muted", !t.prop("muted"))
                }))
            }
        };
        i.init()
        ...
        e.extend({
            simpleWeather: function(n) {
                ...
                var r = new Date,
                    i = "https://query.yahooapis.com/v1/public/yql?format=json&rnd=" + r.getFullYear() + r.getMonth() + r.getDay() + r.getHours() + "&diagnostics=true&callback=?&q=";
                if ("" !== n.location) i += 'select * from weather.forecast where woeid in (select woeid from geo.placefinder where text="' + n.location + '" and gflags="R" limit 1) and u="' + n.unit + '"';
                else {
                    if ("" === n.woeid) return n.error({
                        message: "Could not retrieve weather due to an invalid location."
                    }), !1;
                    i += "select * from weather.forecast where woeid=" + n.woeid + ' and u="' + n.unit + '"'
                }
                return e.getJSON(encodeURI(i), function(e) {
                    if (null !== e && null !== e.query && null !== e.query.results && "Yahoo! Weather Error" !== e.query.results.channel.description) {
                        var r, i = e.query.results.channel,
                            s = {},
                            o = ["N", "NNE", "NE", "ENE", "E", "ESE", "SE", "SSE", "S", "SSW", "SW", "WSW", "W", "WNW", "NW", "NNW", "N"],
                            u = "https://s.yimg.com/os/mit/media/m/weather/images/icons/l/44d-100567.png";
                        s.title = i.item.title, s.temp = i.item.condition.temp, s.code = i.item.condition.code, s.todayCode = i.item.forecast[0].code, s.currently = i.item.condition.text, s.high = i.item.forecast[0].high, s.low = i.item.forecast[0].low, s.text = i.item.forecast[0].text, s.humidity = i.atmosphere.humidity, s.pressure = i.atmosphere.pressure, s.rising = i.atmosphere.rising, s.visibility = i.atmosphere.visibility, s.sunrise = i.astronomy.sunrise, s.sunset = i.astronomy.sunset, s.description = i.item.description, s.city = i.location.city, s.country = i.location.country, s.region = i.location.region, s.updated = i.item.pubDate, s.link = i.item.link, s.units = {
                            temp: i.units.temperature,
                            distance: i.units.distance,
                            pressure: i.units.pressure,
                            speed: i.units.speed
                        }, s.wind = {
                            chill: i.wind.chill,
                            direction: o[Math.round(i.wind.direction / 22.5)],
                            speed: i.wind.speed
                        }, s.heatindex = i.item.condition.temp < 80 && i.atmosphere.humidity < 40 ? -42.379 + 2.04901523 * i.item.condition.temp + 10.14333127 * i.atmosphere.humidity - .22475541 * i.item.condition.temp * i.atmosphere.humidity - 6.83783 * Math.pow(10, -3) * Math.pow(i.item.condition.temp, 2) - 5.481717 * Math.pow(10, -2) * Math.pow(i.atmosphere.humidity, 2) + 1.22874 * Math.pow(10, -3) * Math.pow(i.item.condition.temp, 2) * i.atmosphere.humidity + 8.5282 * Math.pow(10, -4) * i.item.condition.temp * Math.pow(i.atmosphere.humidity, 2) - 1.99 * Math.pow(10, -6) * Math.pow(i.item.condition.temp, 2) * Math.pow(i.atmosphere.humidity, 2) : i.item.condition.temp, "3200" == i.item.condition.code ? (s.thumbnail = u, s.image = u) : (s.thumbnail = "https://s.yimg.com/zz/combo?a/i/us/nws/weather/gr/" + i.item.condition.code + "ds.png", s.image = "https://s.yimg.com/zz/combo?a/i/us/nws/weather/gr/" + i.item.condition.code + "d.png"), s.alt = {
                            temp: t(n.unit, i.item.condition.temp),
                            high: t(n.unit, i.item.forecast[0].high),
                            low: t(n.unit, i.item.forecast[0].low)
                        }, s.alt.unit = "f" === n.unit ? "c" : "f", s.forecast = [];
                        for (var a = 0; a < i.item.forecast.length; a++) r = i.item.forecast[a], r.alt = {
                            high: t(n.unit, i.item.forecast[a].high),
                            low: t(n.unit, i.item.forecast[a].low)
                        }, "3200" == i.item.forecast[a].code ? (r.thumbnail = u, r.image = u) : (r.thumbnail = "https://s.yimg.com/zz/combo?a/i/us/nws/weather/gr/" + i.item.forecast[a].code + "ds.png", r.image = "https://s.yimg.com/zz/combo?a/i/us/nws/weather/gr/" + i.item.forecast[a].code + "d.png"), s.forecast.push(r);
                        n.success(s)
                    } else n.error({
    ...
    }(jQuery), define("weather", function() {}), define("modules/aboutus", ["jquery", "domReady", "underscore", "owl", "weather"], function(e, t, n) {
        var r = {
            init: function() {
                this.slider(), e(".js-place-item").each(function() {
                    var t = e(this).data("location"),
                        n = e(this).data("unit"),
                        i = e(this).find(".js-item-weather");
                    r.weather(t, n, i)
                }), t(function() {
                    r.checkSizes()
                }), e(window).resize(n.debounce(function() {
            ...
            checkSizes: function() {
                var t = e(".js-aboutus-slider"),
                    n = e(".new-abs-wrapper");
                t.css("height", "auto").removeClass("absolute-slider").find("img").removeClass("second-state"), e(window).width() > 1024 && n.outerHeight() >= t.outerHeight() && (t.height(n.outerHeight()).addClass("absolute-slider"), r.checkImagesSize(t))
            },
            checkImagesSize: function(t) {
                t.find("img").each(function() {
                    var n = e(this).height();
                    n < t.outerHeight() && e(this).addClass("second-state")
                })
            },
            slider: function() {
                var t = e(".js-aboutus-slider");
                t.owlCarousel(t.data("config"))
            },
            weather: function(t, n, r) {
                var i = "";
                e.simpleWeather({
                    location: t,
                    woeid: "",
        ...
        r.init()
    }), define("modules/mapStyles", [], function() {
        var e = [{
        ...
        return e
    }), define("modules/map", ["jquery", "modules/mapStyles", "velocity"], function(e, t) {
        var n = {
            init: function() {
                e("#map-block").length && this.createMap(), e(".js-map-toggle").click(function() {
                    if (!e(".changing-map").length) {
                        var t = e(".js-map-wrapper"),
                            r = e('.js-map-btn [class*="pe-7s"]');
                        t.hasClass("active") ? n.state.off(r, t) : n.state.on(r, t)
                    }
                })
            },
            state: {
                on: function(e, t) {
                    e.removeClass("pe-7s-map-marker").addClass("pe-7s-close"), t.addClass("changing-map"), t.addClass("active").velocity("stop").velocity({
                        translateY: ["0", "-100%"]
                    }, 500, "ease", function() {
                        t.removeClass("changing-map")
                    })
                },
                off: function(e, t) {
                    e.removeClass("pe-7s-close").addClass("pe-7s-map-marker"), t.addClass("changing-map"), t.velocity("stop").velocity({
                        translateY: ["-100%", "0"]
                    }, 500, "ease", function() {
                        t.removeClass("active changing-map")
                    })
                }
            },
            createMap: function() {
                var n = document.getElementById("map-block"),
                    r = new google.maps.LatLng(e(n).data("lon"), e(n).data("lat")),
                    i = {
                        zoom: 15,
                        center: r,
    ...
    }), define("modernizr", [], window.Modernizr), define(["smoothscroll", "modules/sliders", "modules/portfolio", "modules/blog", "modules/quotes", "modules/clients", "modules/testimonials", "modules/staticHeader", "modules/offers", "modules/menu", "modules/numbers", "modules/validate", "modules/preloader", "modules/aboutus", "modules/map"]);