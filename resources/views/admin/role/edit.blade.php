                                                    ...
                                                    <td class="text-center">
                                                        <ul style="list-style:none">
                                                            <li>
                                                                <label class="form-check-label">
                                                                    @if($permission_val == 1)
                                                                        <input class="form-check-input create-box parent" type="checkbox" name="permissions[{{$permission['slug']}}]" value="{{$permission_val}}" data-id="{{ $permission['slug'] }}" checked> 
                                                            ...
                                                            @foreach($childs as $child)
                                                                <li>
                                                                    <label class="form-check-label">
                                                                        ...
                                                                        <input class="create-box form-check-input child-{{$permission['slug']}}" type="checkbox" name="permissions[{{$child->slug}}]" value="{{permission_val($myrole,$child->slug)}}" data-id="{{ $permission['slug'] }}" checked> 
                                                                            <label class="badge badge-pill badge-success">Active</label>
                                                                        @else
