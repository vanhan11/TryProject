      ...
      <div class="card card-custom card-stretch gutter-b">
        ...
        <div class="card-header border-0 py-5">
          ...
          <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">Blog Management</span>
          </h3>
            ...
            <tbody>
              @foreach ($data as $item)
                <tr>
                    ...
                    <td class="text-truncate" >{!! substr(strip_tags($item->deskripsi),0,50) . "..." !!}</td>
                    <td>{{ $item->created_at }}</td>
                    <td>
                      <a href="{{ route('blog.edit',$item->id) }}" class="btn btn-link btn-info btn-just-icon">
                          <i class="fa fa-pencil-alt"></i>
                      </a>
                      <a href="#" data-href="{{ route('blog.delete',$item->id) }}" class="btn btn-link btn-danger btn-just-icon" id="deleteModal">
