            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header card-header-rose card-header-text">
                        <div class="card-text">
                            <h4 class="card-title">Edit Upcoming Content</h4>
                        </div>
                    </div>
                    <form method="post" action="{{ route('upcoming.update',$data->id) }}" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        <div class="card-body ">
                            <br>
                            <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="{{ $data->tanggal }}" placeholder="Example: 20 December 2021.." name="tanggal">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('upcoming.index') }}" class="btn btn-fill btn-warning"> Back </a>
