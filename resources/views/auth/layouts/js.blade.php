...
<script src="{{asset('assets/backend/js/pages/custom/login/login-general.js?v=7.0.9')}}"></script>
<script src="{{asset('assets/backend/summernote/summernote.min.js')}}"></script>
@stack('js')
